...
Autogenerated by PyXmlMapWrite on Sun Jun 11 01:26:59 2017
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s originator="%s" release="%s" time="%s" packageGuid="%s">\n' % (indent, '_StorageUnit', originator, release, date, guid))
  strapp('\n')
