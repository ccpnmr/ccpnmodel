...
Autogenerated by PyXmlMapWrite on Sat Nov 19 15:38:13 2016
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s release="%s" originator="%s" time="%s" packageGuid="%s">\n' % (indent, '_StorageUnit', release, originator, date, guid))
  strapp('\n')
