...
Autogenerated by PyXmlMapWrite on Fri Apr 20 14:41:15 2018
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s time="%s" originator="%s" release="%s" packageGuid="%s">\n' % (indent, '_StorageUnit', date, originator, release, guid))
  strapp('\n')
