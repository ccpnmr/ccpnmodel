...
Autogenerated by PyXmlMapWrite on Tue Aug 16 03:55:31 2016
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s packageGuid="%s" release="%s" originator="%s" time="%s">\n' % (indent, '_StorageUnit', guid, release, originator, date))
  strapp('\n')
