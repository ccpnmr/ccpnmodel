...
Autogenerated by PyXmlMapWrite on Wed Jun 29 13:17:15 2016
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s packageGuid="%s" release="%s" time="%s" originator="%s">\n' % (indent, '_StorageUnit', guid, release, date, originator))
  strapp('\n')
