...
Autogenerated by PyXmlMapWrite on Tue Oct 18 04:31:54 2016
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s packageGuid="%s" time="%s" release="%s" originator="%s">\n' % (indent, '_StorageUnit', guid, date, release, originator))
  strapp('\n')
