...
Autogenerated by PyXmlMapWrite on Wed Aug  1 16:50:12 2018
...
def saveToStream(stream, topObject, mapping=None, comment=None, simplified=True, compact=True, expanded=False):
  ...
  strapp('%s<%s time="%s" packageGuid="%s" originator="%s" release="%s">\n' % (indent, '_StorageUnit', date, guid, originator, release))
  strapp('\n')
