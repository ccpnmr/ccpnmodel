...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.AnnealProtocol
  contentMap = {}
  ...
  # Attribute AnnealProtocol.ccpnInternalData
  ...
  aList = ['application', 'applicationVersion', 'ccpnInternalData', 'code', 'details', 'methodStoreName', 'name']
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.AnnealProtocolStore
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute AnnealProtocolStore.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.AnnealStage
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute AnnealStage.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'functionParams', 'name', 'potentialScales']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.EnergyTerm
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  aList = ['_ID', 'serial']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'code', 'details', 'name']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.PotentialScale
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute PotentialScale.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'code', 'functionParams']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.RefPotentialTerm
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute RefPotentialTerm.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID', 'index']
  currentMap['headerAttrs'] = aList
  aList = ['application', 'ccpnInternalData', 'code', 'details', 'name', 'potentialScales']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.RefTermParameter
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute RefTermParameter.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
