...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'ccpnInternalData', 'finalTemp', 'function', 'initialTemp', 'numSteps', 'numSubSteps', 'serial', 'timeStep', 'timeStepScaling']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'finalScale', 'function', 'initialScale']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'index']
  currentMap['headerAttrs'] = aList
