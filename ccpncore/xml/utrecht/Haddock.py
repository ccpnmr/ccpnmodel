...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'termId']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'code', 'details', 'fileName', 'name']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'fileNames']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'name', 'workingDir']
  currentMap['simpleAttrs'] = aList
  ...
  aList = ['_ID', 'flexibility', 'haddockSeqId', 'interaction', 'residueSeqId']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'cnsExecutable', 'haddockDir', 'queueCommand']
  currentMap['simpleAttrs'] = aList
