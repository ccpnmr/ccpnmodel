...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.Alignment
  contentMap = {}
  ...
  # Attribute Alignment.ccpnInternalData
  ...
  aList = ['_ID', 'alignLength', 'alignmentScore', 'ccpnInternalData', 'dbRefAlignBegin', 'dbRefAlignEnd', 'homologyRatio', 'nIdentical', 'nPositive', 'serial']
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.MolResLink
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MolResLink.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.MolResLinkEnd
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MolResLinkEnd.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.MolResidue
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MolResidue.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID', 'ccpnInternalData', 'code3Letter', 'linking', 'seqCode', 'serial']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.MolSeqFragment
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MolSeqFragment.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.Molecule
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute Molecule.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID', '_lastId', 'calcIsoelectricPoint', 'ccpnInternalData', 'createdBy', 'guid', 'isFinalised', 'isModifiable', 'lastUnlockedBy', 'smilesType']
  currentMap['headerAttrs'] = aList
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.molecule.Molecule.MoleculeSysName
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MoleculeSysName.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
