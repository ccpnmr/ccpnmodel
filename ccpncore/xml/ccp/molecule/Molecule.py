...
def makeMapping(globalMap):
  ...
  aList = ['alignmentProgram', 'ccpnInternalData', 'details']
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'molResLinkEnds']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'descriptor', 'seqInsertCode']
  currentMap['simpleAttrs'] = aList
  aList = ['molSeqFragment']
  currentMap['optLinks'] = aList
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'alignments', 'limitResidues']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'commonNames', 'details', 'fragmentDetails', 'functions', 'keywords', 'longName', 'mutationDetails', 'name', 'seqDetails', 'smiles']
  currentMap['simpleAttrs'] = aList
