...
def makeMapping(globalMap):
  ...
  aList = ['_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'symmetrySetId']
  ...
  aList = ['_ID', 'ccpnInternalData', 'firstSeqId']
  currentMap['headerAttrs'] = aList
  aList = ['chainCode']
  currentMap['simpleAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'segmentLength', 'serial', 'symmetryCode']
  currentMap['headerAttrs'] = aList
