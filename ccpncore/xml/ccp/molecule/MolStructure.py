...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'ccpnInternalData', 'elementName', 'index', 'name']
  currentMap['headerAttrs'] = aList
  aList = ['altLocationCode', 'implSpecificNames', 'iupacNames']
  ...
  aList = ['_ID', 'ccpnInternalData', 'defaultValue', 'name', 'unit']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'code3Letter', 'seqCode', 'seqId']
  currentMap['headerAttrs'] = aList
  aList = ['seqInsertCode']
  currentMap['simpleAttrs'] = aList
  ...
  aList = ['_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'data', 'ensembleId', 'guid', 'isModifiable', 'lastUnlockedBy', 'softwareName']
  currentMap['headerAttrs'] = aList
