...
Autogenerated by PyXmlMapWrite on Tue Oct 18 04:31:55 2016
...
def makeMapping(globalMap):
  ...
  aList = ['ccpnInternalData', 'chemAngles', 'chemBonds', 'chemCompVars', 'chemTorsions', 'coreStereochemistries', 'stereochemistries']
  ...
  currentMap['headerAttrs'] = aList
  aList = ['altSysNames', 'ccpnInternalData', 'sysName']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'chemAtoms']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'chemAtomSets', 'chemAtoms']
  currentMap['simpleAttrs'] = aList
  aList = ['chemAtomSet']
  ...
  currentMap['headerAttrs'] = aList
  aList = ['baseGlycoCtCode', 'ccpnInternalData', 'commonNames', 'details', 'keywords', 'name']
  currentMap['simpleAttrs'] = aList
  ...
  aList = ['_ID', 'sysName']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'specificChemCompVars']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'descriptor', 'glycoCtCode', 'nonStereoSmiles', 'stereoSmiles', 'varName', 'chemAtoms', 'specificSysNames']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  aList = ['_ID', 'name']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'chemAtoms', 'sysNames']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  aList = ['_ID', 'linkCode']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'boundLinkAtom', 'remoteLinkAtom']
  currentMap['simpleAttrs'] = aList
  ...
  aList = ['_ID', 'name']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'atomSetVariantSystems', 'atomVariantSystems']
  currentMap['simpleAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'chemAtoms', 'coreAtoms']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'shortVegaType', 'boundLinkEnds', 'chemAngles', 'chemBonds', 'chemCompVars', 'chemTorsions', 'coreStereochemistries', 'remoteLinkEnds', 'stereochemistries']
  currentMap['simpleAttrs'] = aList
  aList = ['chemAtomSet']
  currentMap['optLinks'] = aList
  aList = ['applicationData']
  ...
  aList = ['_ID', 'name', 'subType']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'boundLinkEnd', 'chemAngles', 'chemBonds', 'chemCompVars', 'chemTorsions', 'coreStereochemistries', 'remoteLinkEnd', 'stereochemistries']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
