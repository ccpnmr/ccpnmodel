...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'atomNumber', 'atomicRadius', 'ccpnInternalData', 'covalentRadius', 'mass', 'name', 'symbol']
  ...
  aList = ['_ID', 'abundance', 'ccpnInternalData', 'gyroMagneticRatio', 'halfLife', 'halfLifeError', 'halfLifeType', 'magneticMoment', 'mass', 'massNumber', 'quadrupoleMoment', 'receptivity', 'spin']
  currentMap['headerAttrs'] = aList
