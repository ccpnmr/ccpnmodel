...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'ccpnInternalData', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph']
  ...
  aList = ['_ID', 'ccpnInternalData', 'concentration', 'concentrationError', 'concentrationUnit', 'labeling', 'purity']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'amount', 'amountUnit', 'batchIdentifier', 'ccpnInternalData', 'colPosition', 'creationDate', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph', 'plateIdentifier', 'rowPosition', 'subPosition']
  currentMap['headerAttrs'] = aList
  aList = ['details', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['sampleComponents', 'applicationData']
  ...
  aList = ['_ID', 'a', 'alpha', 'amount', 'amountUnit', 'b', 'batchIdentifier', 'beta', 'c', 'ccpnInternalData', 'colPosition', 'creationDate', 'gamma', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph', 'plateIdentifier', 'rowPosition', 'spaceGroup', 'subPosition', 'x', 'y', 'z']
  currentMap['headerAttrs'] = aList
