...
def makeMapping(globalMap):
  ...
  # Attribute AbstractSample.ccpnInternalData
  ...
  # Attribute AbstractSample.serial
  currentMap = {}
  contentMap['serial'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_Fogh_2016-11-19-21:01:25_00001'] = currentMap
  loadMaps['SAM.AbstractSample.serial'] = currentMap
  currentMap['tag'] = 'SAM.AbstractSample.serial'
  currentMap['type'] = 'attr'
  currentMap['guid'] = 'www.ccpn.ac.uk_Fogh_2016-11-19-21:01:25_00001'
  ...
  aList = ['_ID', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph', 'serial']
  ...
  # Attribute SampleComponent.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'chainCodes', 'details', 'name', 'role', 'contents']
  currentMap['simpleAttrs'] = aList
  aList = ['container']
  ...
  # Attribute SampleStore.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  # Attribute Sample.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  # Attribute Sample.serial
  contentMap['serial'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-11-19-21:01:25_00001')
  ...
  aList = ['_ID', 'amount', 'amountUnit', 'batchIdentifier', 'colPosition', 'creationDate', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph', 'plateIdentifier', 'rowPosition', 'serial', 'subPosition']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'details', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['sampleComponents', 'applicationData']
  ...
  # Attribute CrystalSample.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  # Attribute CrystalSample.serial
  contentMap['serial'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-11-19-21:01:25_00001')
  ...
  aList = ['_ID', 'a', 'alpha', 'amount', 'amountUnit', 'b', 'batchIdentifier', 'beta', 'c', 'colPosition', 'creationDate', 'gamma', 'ionicStrength', 'isHazardous', 'isVirtual', 'ph', 'plateIdentifier', 'rowPosition', 'serial', 'spaceGroup', 'subPosition', 'x', 'y', 'z']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'colour', 'crystalType', 'details', 'morphology', 'name']
  currentMap['simpleAttrs'] = aList
  aList = ['sampleComponents', 'applicationData']
  currentMap['cplxAttrs'] = aList
  aList = ['sampleComponents']
