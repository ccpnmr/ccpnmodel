...
def makeMapping(globalMap):
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.general.Method.Method
  contentMap = {}
  ...
  # Attribute Method.ccpnInternalData
  ...
  aList = ['ccpnInternalData', 'details', 'name', 'procedure', 'task']
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.general.Method.MethodStore
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute MethodStore.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  currentMap['objkey'] = 'serial'
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.general.Method.Parameter
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  currentMap['class'] = ccpnmodel.ccpncore.api.ccp.general.Method.Software
  contentMap = {}
  currentMap['content'] = contentMap
  ...
  # Attribute Software.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'details', 'name', 'tasks', 'vendorAddress', 'vendorName', 'vendorWebAddress', 'version', 'methods']
  currentMap['simpleAttrs'] = aList
