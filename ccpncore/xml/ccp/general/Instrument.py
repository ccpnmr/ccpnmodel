...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'ccpnInternalData', 'diameter', 'serial']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'nominalFreq', 'protonFreq', 'serial']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'serial', 'volume', 'volumeDisplayUnit']
  currentMap['headerAttrs'] = aList
