...
def makeMapping(globalMap):
  ...
  # Attribute Entry.ccpnInternalData
  ...
  aList = ['bmrbProcessing', 'ccpnInternalData', 'details', 'entryType', 'experimentListDetails', 'keywords', 'name', 'title']
  ...
  # Attribute EntryMolecule.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'productionMethod', 'sourceType', 'vectorType']
  currentMap['simpleAttrs'] = aList
  ...
  # Attribute NmrEntryStore.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  # Attribute RelatedEntry.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'dbCode', 'dbName', 'details', 'relationship']
  currentMap['simpleAttrs'] = aList
  ...
  # Attribute Study.ccpnInternalData
  contentMap['ccpnInternalData'] = mapsByGuid.get('www.ccpn.ac.uk_Fogh_2016-06-28-10:49:27_00001')
  ...
  aList = ['_ID']
  currentMap['headerAttrs'] = aList
  aList = ['ccpnInternalData', 'details', 'keywords', 'name', 'studyType', 'entries']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
