...
def makeMapping(globalMap):
  ...
  # Attribute Integral.multipletType
  currentMap = {}
  contentMap['multipletType'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_EJB_2018-04-21-18:48:51_00002'] = currentMap
  loadMaps['NMR.Integral.multipletType'] = currentMap
  currentMap['tag'] = 'NMR.Integral.multipletType'
  currentMap['type'] = 'attr'
  currentMap['guid'] = 'www.ccpn.ac.uk_EJB_2018-04-21-18:48:51_00002'
  ...
  aList = ['_ID', 'constraintWeight', 'figOfMerit', 'height', 'heightError', 'offset', 'position', 'positionError', 'serial', 'volume', 'volumeError']
  currentMap['headerAttrs'] = aList
  aList = ['annotation', 'ccpnInternalData', 'details', 'multipletType', 'peak']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
