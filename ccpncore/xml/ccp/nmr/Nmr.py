...
def makeMapping(globalMap):
  ...
  # Role DataSource.multiplets
  currentMap = {}
  contentMap['multiplets'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_Fogh_2018-04-17-13:28:09_00002'] = currentMap
  loadMaps['NMR.DataSource.multiplets'] = currentMap
  currentMap['tag'] = 'NMR.DataSource.multiplets'
  currentMap['type'] = 'child'
  currentMap['guid'] = 'www.ccpn.ac.uk_Fogh_2018-04-17-13:28:09_00002'
  ...
  aList = ['processedFrom']
  currentMap['optLinks'] = aList
  aList = ['spectrumHits', 'sparseSamplings', 'peakLists', 'multiplets', 'multipletLists', 'dataSourceImages', 'dataDims', 'snMethod', 'processMethod', 'dataStore', 'compressMethod', 'applicationData']
  currentMap['cplxAttrs'] = aList
  aList = ['dataDims', 'dataSourceImages', 'multipletLists', 'multiplets', 'peakLists', 'sparseSamplings', 'spectrumHits']
  currentMap['children'] = aList
  ...
  # Attribute Multiplet.clusterType
  currentMap = {}
  contentMap['clusterType'] = currentMap
  mapsByGuid['www.ccpn.ac.uk_EJB_2018-04-20-10:54:04_00002'] = currentMap
  loadMaps['NMR.Multiplet.clusterType'] = currentMap
  currentMap['tag'] = 'NMR.Multiplet.clusterType'
  currentMap['type'] = 'attr'
  ...
  aList = ['_ID', 'clusterType', 'constraintWeight', 'figOfMerit', 'height', 'heightError', 'offset', 'serial', 'volume', 'volumeError']
  currentMap['headerAttrs'] = aList
  aList = ['annotation', 'ccpnInternalData', 'details', 'peaks']
  currentMap['simpleAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
