...
Autogenerated by PyXmlMapWrite on Sat Apr 15 01:52:41 2017
...
def makeMapping(globalMap):
  ...
  currentMap['headerAttrs'] = aList
  aList = ['annotation', 'ccpnInternalData', 'componentNumbers', 'details', 'dataDerivations', 'measurements', 'peakClusters']
  currentMap['simpleAttrs'] = aList
