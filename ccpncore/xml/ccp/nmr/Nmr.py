...
def makeMapping(globalMap):
  ...
  mapsByGuid['www.ccpn.ac.uk_EJB_2018-04-21-08:58:44_00001'] = currentMap
  loadMaps['NMR.DirectNmrChainLinkType'] = currentMap
  currentMap['tag'] = 'NMR.DirectNmrChainLinkType'
  currentMap['type'] = 'simple'
  currentMap['guid'] = 'www.ccpn.ac.uk_EJB_2018-04-21-08:58:44_00001'
  currentMap['toStr'] = 'text'
  currentMap['cnvrt'] = 'text'
  ...
  aList = ['processedFrom']
  currentMap['optLinks'] = aList
  aList = ['spectrumHits', 'sparseSamplings', 'peakLists', 'multipletLists', 'dataSourceImages', 'dataDims', 'snMethod', 'processMethod', 'dataStore', 'compressMethod', 'applicationData']
  currentMap['cplxAttrs'] = aList
  aList = ['dataDims', 'dataSourceImages', 'multipletLists', 'peakLists', 'sparseSamplings', 'spectrumHits']
  currentMap['children'] = aList
  ...
  currentMap['headerAttrs'] = aList
  aList = ['annotation', 'ccpnInternalData', 'componentNumbers', 'details', 'dataDerivations', 'measurements', 'multiplets', 'peakClusters']
  currentMap['simpleAttrs'] = aList
