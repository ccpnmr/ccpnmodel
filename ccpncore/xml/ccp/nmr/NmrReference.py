...
def makeMapping(globalMap):
  ...
  aList = ['_ID', 'ccpnInternalData', 'defaultValue', 'serial']
  ...
  aList = ['_ID', 'ccpnInternalData', 'meanValue', 'name', 'randomCoilValue', 'refPoint', 'refValue', 'serial', 'stdDev', 'subType', 'valuePerPoint']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', 'ccpCode', 'ccpnInternalData', 'molType', 'seqOffset', 'value']
  currentMap['headerAttrs'] = aList
  aList = ['applicationData']
  currentMap['cplxAttrs'] = aList
  ...
  aList = ['_ID', 'ccpnInternalData', 'linking']
  currentMap['headerAttrs'] = aList
  ...
  aList = ['_ID', '_lastId', 'ccpCode', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'molType']
  currentMap['headerAttrs'] = aList
  aList = ['name']
  currentMap['simpleAttrs'] = aList
