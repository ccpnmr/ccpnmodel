...
Autogenerated by PyFileApiGen on Wed Jun 29 13:17:21 2016
...
class DataObject(MemopsObject):
  ...
  r"""Multiple-type attribute - can be of any of the several types supported 
  by the Multiple data type.
  Allows storing arbitrty data structures. For 
  use by CCPN applicatoins only.
  """)
