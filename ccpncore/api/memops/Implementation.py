...
Autogenerated by PyFileApiGen on Tue Aug 16 03:55:40 2016
...
from ccpnmodel.ccpncore.memops.baseDataTypes import Any
from ccpnmodel.ccpncore.memops.baseDataTypes import Boolean
from ccpnmodel.ccpncore.memops.baseDataTypes import DateTime
from ccpnmodel.ccpncore.memops.baseDataTypes import Dict
from ccpnmodel.ccpncore.memops.baseDataTypes import Float
from ccpnmodel.ccpncore.memops.baseDataTypes import IeeeFloat
from ccpnmodel.ccpncore.memops.baseDataTypes import Int
from ccpnmodel.ccpncore.memops.baseDataTypes import Multiple
from ccpnmodel.ccpncore.memops.baseDataTypes import String
...
Contains some implementation attributes
  """
  #   from data model element memops.Implementation.ComplexDataType
...
class MemopsDataTypeObject(ComplexDataType):
  ...
  """
  #   from data model element memops.Implementation.MemopsDataTypeObject
  ...
  def __lt__(self, value):
    """
     less-than function. With functools.totalordering allows object comparison.
    """
    dataDict = self.__dict__
    return (self.getQualifiedName(),tuple((x, dataDict[x]) for x in sorted(dataDict))) < (value.getQualifiedName(),tuple((x, value.__dict__[x]) for x in sorted(value.__dict__)))
  
  def __eq__(self, value):
    """
     equality function. With functools.totalordering allows object comparison.
    """
    dataDict = self.__dict__
    try:
      return (self.getQualifiedName(),tuple((x, dataDict[x]) for x in sorted(dataDict))) == (value.getQualifiedName(),tuple((x, value.__dict__[x]) for x in sorted(value.__dict__)))
...
class SymmTracelessMatrix(MemopsDataTypeObject):
  ...
  """
  #   from data model element memops.Implementation.SymmTracelessMatrix
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.SymmTracelessMatrix.__init__")
      del dataDict['inConstructor']
      raise
...
class Url(MemopsDataTypeObject):
  ...
  """
  #   from data model element memops.Implementation.Url
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.Url.__init__")
      del dataDict['inConstructor']
      raise
...
ApplicationData
  """
  #   from data model element memops.Implementation.ApplicationData
...
class AppDataString(ApplicationData):
  ...
  """
  #   from data model element memops.Implementation.AppDataString
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.AppDataString.__init__")
      del dataDict['inConstructor']
      raise
...
class AppDataFloat(ApplicationData):
  ...
  """
  #   from data model element memops.Implementation.AppDataFloat
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.AppDataFloat.__init__")
      del dataDict['inConstructor']
      raise
...
class AppDataBoolean(ApplicationData):
  ...
  """
  #   from data model element memops.Implementation.AppDataBoolean
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.AppDataBoolean.__init__")
      del dataDict['inConstructor']
      raise
...
class AppDataInt(ApplicationData):
  ...
  """
  #   from data model element memops.Implementation.AppDataInt
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      self.root._logger.error("in memops.Implementation.AppDataInt.__init__")
      del dataDict['inConstructor']
      raise
...
links. 
  """
  #   from data model element memops.Implementation.MemopsObject
  ...
  def __hash__(self):
    """
     hash function. Necessary now we have __eq__.
    """
    return hash(id(self))
  
  def __lt__(self, value):
    """
     comparison function. With functools.totalordering allows object comparison.
    """
...
_addModuleFunctionsToApiClass('memops.Implementation.MemopsObject', MemopsObject)

###############################################################################
class DataObject(MemopsObject):
  r"""Superclass for non-implementation classes
  """
  #   from data model element memops.Implementation.DataObject
  _metaclass = metaPackage.getElement('DataObject')
  _packageName = 'memops.Implementation'
  _packageShortName = 'IMPL'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'root', 'topObject',)
  ...
  def addApplicationData(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setApplicationData, self.addApplicationData,
  ...
  def getCcpnInternalData(self):
    """
    Get for memops.Implementation.DataObject.ccpnInternalData
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('topObject').__dict__.get('isLoaded') or dataDict.get('topObject').__dict__.get('isReading')))):
      dataDict.get('topObject').load()

    result = dataDict.get('ccpnInternalData')
    return result
  ...
  def get_ID(self):
    """
    Get for memops.Implementation.DataObject._ID
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('topObject').__dict__.get('isLoaded') or dataDict.get('topObject').__dict__.get('isReading')))):
      dataDict.get('topObject').load()

    result = dataDict.get('_ID')
    return result
  ...
  def removeApplicationData(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setApplicationData, self.removeApplicationData,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setApplicationData(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setApplicationData, self.setApplicationData,
                      undoArgs=(currentValues,), redoArgs=(values,))

  def setCcpnInternalData(self, value):
    """
    Set for memops.Implementation.DataObject.ccpnInternalData
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, Multiple.PythonType)):
        pass
      else:
        raise ApiError("""%s.setCcpnInternalData:
    ...
    currentValue = dataDict.get('ccpnInternalData')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    dataDict['ccpnInternalData'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setCcpnInternalData')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCcpnInternalData, self.setCcpnInternalData,
                      undoArgs=(currentValue,), redoArgs=(value,))

  def set_ID(self, value):
    """
    Set for memops.Implementation.DataObject._ID
    """
    dataDict = self.__dict__
    if (isinstance(value, Int.PythonType)):
      pass
    else:
      raise ApiError("""%s.set_ID:
       memops.Implementation.Int input is not of a valid type""" % self.qualifiedName
       + ": %s" % (value,)
      )
    ...
    if (notOverride):
      if (notInConstructor):
        raise ApiError("""%s.set_ID:
         cannot set _ID, frozen""" % self.qualifiedName
         + ": %s" % (self,)
        )
    ...
    _lastId = topObject.__dict__.get('_lastId')
    if (value < 0):
      value = (_lastId + 1)
      topObject.__dict__['_lastId'] = value
    elif (value > _lastId):
      topObject.__dict__['_lastId'] = value
  ...
  _ID = property(get_ID, set_ID, None,
  r"""Persistent object ID
  """)
  ...
  ccpnInternalData = property(getCcpnInternalData, setCcpnInternalData, None,
  r"""Multiple-type attribute - A dictionary that can contain any of the 
  several types supported by the Multiple data type. Allows storing 
  arbitrary data structures. For use by CCPN applications only.
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.DataObject', DataObject)

###############################################################################
class ImplementationObject(MemopsObject):
  r"""Superclass for Implementation package objects
  """
  #   from data model element memops.Implementation.ImplementationObject
  _metaclass = metaPackage.getElement('ImplementationObject')
  _packageName = 'memops.Implementation'
  _packageShortName = 'IMPL'
  _fieldNames = ('_ID', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'root', 'topObject',)
  ...
  def get_ID(self):
    """
    Get for memops.Implementation.ImplementationObject._ID
    """
    dataDict = self.__dict__
    result = dataDict.get('_ID')
    return result
  ...
  def set_ID(self, value):
    """
    Set for memops.Implementation.ImplementationObject._ID
    """
    dataDict = self.__dict__
    if (isinstance(value, Int.PythonType)):
      pass
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.ImplementationObject', ImplementationObject)
...
operations are different in File and Db implementations
  """
  #   from data model element memops.Implementation.TopObject
  _metaclass = metaPackage.getElement('TopObject')
  _packageName = 'memops.Implementation'
  _packageShortName = 'IMPL'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'memopsRoot', 'packageLocator', 'root', 'topObject',)
  ...
  def findAllActiveRepositories(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'format', 'name', 'url', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.append(v)
  ...
  getCcpnInternalData = DataObject.getCcpnInternalData
  ...
  get_ID = DataObject.get_ID
  
  def get_lastId(self):
    """
    Get for memops.Implementation.TopObject._lastId
    """
    dataDict = self.__dict__
    result = dataDict.get('_lastId')
    return result
  ...
  def removeFrom(self, repository):
    ...
    fileLocation = ApiPath.findTopObjectPath(repository.url.getDataLocation(), self)
    import os
    try:
    ...
    if repository in activeRepositories and not self.isDeleted:
    ...
    if undo is not None and not self.isDeleted:
      # If object is deleted, nothing is undone. When (if ever) it is undeleted, it will be in memory and modified.
      undo.newItem(self.saveTo, self.removeFrom, undoArgs=(repository,), redoArgs=(repository,))
  ...
  def saveTo(self, repository):
    ...
    if repository.format == 'xml' and repository.url.protocol == 'file':
      ...
      undo = self.root._undo
      if undo is not None:
        undo.newItem(self.removeFrom, self.saveTo,  undoArgs=(repository,), redoArgs=(repository,))
  ...
  setCcpnInternalData = DataObject.setCcpnInternalData
  ...
  def setIsModifiable(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIsModifiable, self.setIsModifiable,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  set_ID = DataObject.set_ID
  
  def set_lastId(self, value):
    """
    Set for memops.Implementation.TopObject._lastId
    """
    dataDict = self.__dict__
    if (isinstance(value, Int.PythonType)):
      pass
    else:
      raise ApiError("""%s.set_lastId:
       memops.Implementation.Int input is not of a valid type""" % self.qualifiedName
       + ": %s" % (value,)
      )
    ...
    currentValue = dataDict.get('_lastId')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if (notOverride):
      if (notInConstructor):
        raise ApiError("""%s.set_lastId:
         cannot set _lastId, frozen""" % self.qualifiedName
         + ": %s" % (self,)
        )
  ...
  _lastId = property(get_lastId, set_lastId, None,
  r"""Last ID used among descendants of topObject
  """)

  applicationData = DataObject.applicationData

  ccpnInternalData = DataObject.ccpnInternalData
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.TopObject', TopObject)

###############################################################################
class MemopsRoot(ImplementationObject):
  r"""Unique root class, located at the top of the parent-child tree of 
objects. The  attributes and operations are different in the File and Db 
Implementations
  """
  #   from data model element memops.Implementation.MemopsRoot
  ...
  _fieldNames = ('_ID', '_lastId', 'accessControlOn', 'className', 'createdBy', 'currentGroupName', 'currentUserId', 'fieldNames', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'override', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'affiliationStores', 'annealProtocolStores', 'annotationStores', 'chemCompCharges', 'chemCompCoords', 'chemComps', 'chemElementStores', 'citationStores', 'currentAffiliationStore', 'currentAnnealProtocolStore', 'currentAnnotationStore', 'currentChemComp', 'currentChemCompCharge', 'currentChemCompCoord', 'currentChemElementStore', 'currentCitationStore', 'currentDangleStore', 'currentDataLocationStore', 'currentDatabase', 'currentGuiTask', 'currentHaddockProject', 'currentInstrumentStore', 'currentKeywordDefinitionStore', 'currentLabeledMolecule', 'currentLabelingScheme', 'currentMethodStore', 'currentMolSystem', 'currentMolSystemSymmetrySet', 'currentMolecule', 'currentNmrCalcStore', 'currentNmrConstraintStore', 'currentNmrEntryStore', 'currentNmrExpPrototype', 'currentNmrProject', 'currentNmrReferenceStore', 'currentRefSampleComponentStore', 'currentSampleStore', 'currentStereochemistryStore', 'currentStructureEnsemble', 'currentTaxonomy', 'currentValidationStore', 'currentWindowStore', 'currentWmsProtocol', 'dangleStores', 'dataLocationStores', 'databases', 'guiTasks', 'haddockProjects', 'instrumentStores', 'keywordDefinitionStores', 'labeledMolecules', 'labelingSchemes', 'methodStores', 'molSystemSymmetrySets', 'molSystems', 'molecules', 'nmrCalcStores', 'nmrConstraintStores', 'nmrEntryStores', 'nmrExpPrototypes', 'nmrProjects', 'nmrReferenceStores', 'packageLocator', 'packageLocators', 'parent', 'refSampleComponentStores', 'repositories', 'root', 'sampleStores', 'stereochemistryStores', 'structureEnsembles', 'taxonomies', 'topObject', 'topObjects', 'validationStores', 'windowStores', 'wmsProtocols',)
  ...
  def __init__(self, **attrlinks):
    ...
    try:
      ...
      dataDict['currentWindowStore'] = None
      ...
      dataDict['windowStores'] = {}
      dataDict['wmsProtocols'] = {}
      dataDict['topObjects'] = {}
      dataDict['activeRepositories'] = list()

      dataDict['inConstructor'] = True
      # Hack for handling the root implementation attribute
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('memops.Implementation.MemopsRoot', value)
          )
  ...
  def _unDelete(self, objsToBeUnDeleted, topObjectsToCheck):
    """
    unDelete for memops.Implementation.MemopsRoot:
       reverses deletion for 
    objects in objsToBeUnDeleted.
       *Implementation function* - should be 
    called only by API undo machinery.
    """
    dataDict = self.__dict__
    topObject = dataDict.get('topObject')
    for topObjectToCheck in topObjectsToCheck:
      if (not (topObjectToCheck.__dict__.get('isModifiable'))):
        raise ApiError("""%s._unDelete:
         Storage not modifiable""" % self.qualifiedName
         + ": %s" % (topObjectToCheck,)
        )

    for obj in objsToBeUnDeleted:
      if (not (obj.__dict__.get('isDeleted'))):
        raise ApiError("""%s._unDelete:
         an object in objsToBeUnDeleted is not deleted""" % self.qualifiedName
        )

    for obj in objsToBeUnDeleted:
      obj._singleUnDelete(objsToBeUnDeleted)
  ...
  def checkAllValid(self, complete=False):
    ...
    values = dataDict.get('guiTasks').values()
    for value in values:
      value.checkAllValid(complete)
    ...
    values = dataDict.get('windowStores').values()
    for value in values:
      value.checkAllValid(complete)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      values = dataDict.get('affiliationStores').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.general.Affiliation import AffiliationStore as importedType
      ...
      values = dataDict.get('annealProtocolStores').values()
      for value in values:
        from ccpnmodel.ccpncore.api.molsim.AnnealProtocol import AnnealProtocolStore as importedType
        if (not isinstance(value, importedType)):
      ...
      values = dataDict.get('annotationStores').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.general.Annotation import AnnotationStore as importedType
        if (not isinstance(value, importedType)):
      ...
      values = dataDict.get('chemCompCharges').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.molecule.ChemCompCharge import ChemCompCharge as importedType
        if (not isinstance(value, importedType)):
      ...
      values = dataDict.get('chemCompCoords').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.molecule.ChemCompCoord import ChemCompCoord as importedType
        if (not isinstance(value, importedType)):
      ...
      values = dataDict.get('chemElementStores').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.molecule.ChemElement import ChemElementStore as importedType
        if (not isinstance(value, importedType)):
      ...
      values = dataDict.get('citationStores').values()
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.general.Citation import CitationStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.cambridge.Dangle import DangleStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.DataLocation import DataLocationStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.DbRef import Database as importedType
        if (not isinstance(value, importedType)):
      ...
      value = dataDict.get('currentGuiTask')
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccpnmr.gui.Task import GuiTask as importedType
        if (not isinstance(value, importedType)):
          raise ApiError("""%s.checkValid: currentGuiTask:
        ...
        if (not (xx1 is yy1)):
          raise ApiError("""%s.checkValid: currentGuiTask:
           Link currentGuiTask between objects from separate partitions
            - memops.Implementation.MemopsRoot does not match""" % self.qualifiedName
           + ": %s:%s" % (self, value)
          )
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.utrecht.Haddock import HaddockProject as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.Instrument import InstrumentStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.KeywordDefinition import KeywordDefinitionStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.molecule.LabeledMolecule import LabeledMolecule as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.Method import MethodStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.nmr.NmrCalc import NmrCalcStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.nmr.NmrEntry import NmrEntryStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.nmr.NmrExpPrototype import NmrExpPrototype as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.nmr.NmrReference import NmrReferenceStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.molecule.Stereochemistry import StereochemistryStore as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.Taxonomy import Taxonomy as importedType
        if (not isinstance(value, importedType)):
      ...
      value = dataDict.get('currentWindowStore')
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccpnmr.gui.Window import WindowStore as importedType
        if (not isinstance(value, importedType)):
          raise ApiError("""%s.checkValid: currentWindowStore:
        ...
        if (not (xx1 is yy1)):
          raise ApiError("""%s.checkValid: currentWindowStore:
           Link currentWindowStore between objects from separate partitions
            - memops.Implementation.MemopsRoot does not match""" % self.qualifiedName
           + ": %s:%s" % (self, value)
          )
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.cambridge.WmsProtocol import WmsProtocol as importedType
        if (not isinstance(value, importedType)):
      ...
      for value in values:
        from ccpnmodel.ccpncore.api.ccpnmr.gui.Task import GuiTask as importedType
        if (not isinstance(value, importedType)):
          raise ApiError("""%s.checkValid: guiTasks:
           value is not of class ccpnmr.gui.Task.GuiTask""" % self.qualifiedName
           + ": %s" % (value,)
          )
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: guiTasks:
           non-reciprocal link guiTasks from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        from ccpnmodel.ccpncore.api.ccpnmr.gui.Window import WindowStore as importedType
        if (not isinstance(value, importedType)):
          raise ApiError("""%s.checkValid: windowStores:
           value is not of class ccpnmr.gui.Window.WindowStore""" % self.qualifiedName
           + ": %s" % (value,)
          )
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: windowStores:
           non-reciprocal link windowStores from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def findAllAffiliationStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllChemCompCharges(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpCode', 'ccpnInternalData', 'createdBy', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'molType', 'sourceName', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllChemComps(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'baseGlycoCtCode', 'beilsteinCode', 'casRegCode', 'ccpCode', 'ccpnInternalData', 'code3Letter', 'createdBy', 'details', 'guid', 'hasStdChirality', 'isModifiable', 'lastUnlockedBy', 'merckCode', 'molType', 'name', 'sigmaAldrichCode', 'stdChemCompCode', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDangleStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'colorScheme', 'createdBy', 'dbLocation', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDatabases(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'details', 'fullName', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'url', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllGuiTasks(self, **conditions):
    """
    FindAll for memops.Implementation.MemopsRoot.guiTasks
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.gui.Task')
      currentValues = dataDict.get('guiTasks').values()
      result = set(currentValues)
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'nameSpace', 'nmrProjectName', 'memopsRoot', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllHaddockProjects(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'workingDir', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllKeywordDefinitionStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'context', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllLabelingSchemes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'longName', 'name', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMolecules(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'calcIsoelectricPoint', 'ccpnInternalData', 'createdBy', 'details', 'fragmentDetails', 'guid', 'isFinalised', 'isModifiable', 'lastUnlockedBy', 'longName', 'mutationDetails', 'name', 'seqDetails', 'smiles', 'smilesType', 'memopsRoot', 'naturalSource',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllNmrCalcStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'nmrProjectName', 'validationStoreName', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllNmrConstraintStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'creationDate', 'dataPath', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'programName', 'programVersion', 'serial', 'uuid', 'memopsRoot', 'nmrProject', 'primaryStructureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllNmrExpPrototypes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'category', 'ccpnInternalData', 'createdBy', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'priority', 'serial', 'synonym', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllNmrReferenceStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpCode', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'molType', 'name', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllPackageLocators(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'targetName', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllStructureEnsembles(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'atomNamingSystem', 'ccpnInternalData', 'createdBy', 'data', 'dataPath', 'details', 'ensembleId', 'guid', 'isModifiable', 'lastUnlockedBy', 'resNamingSystem', 'softwareName', 'memopsRoot', 'molSystem', 'nmrConstraintStore', 'primaryNmrConstraintStore', 'structureGeneration',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllTopObjects(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllWindowStores(self, **conditions):
    """
    FindAll for memops.Implementation.MemopsRoot.windowStores
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
      root = self
      root.refreshTopObjects('ccpnmr.gui.Window')
      currentValues = dataDict.get('windowStores').values()
      result = set(currentValues)
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'ccpnInternalData', 'createdBy', 'guid', 'isModifiable', 'lastUnlockedBy', 'mainWindow', 'memopsRoot', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllWmsProtocols(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', '_lastId', 'annealProtocolCode', 'annealProtocolStoreName', 'ccpnInternalData', 'createdBy', 'details', 'guid', 'isModifiable', 'lastUnlockedBy', 'name', 'softwareName', 'softwareVersion', 'memopsRoot',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findFirstGuiTask(self, **conditions):
    """
    FindFirst for memops.Implementation.MemopsRoot.guiTasks
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
      ...
      ll = list()
      objKey = conditions.get('nameSpace')
      ll.append(objKey)
      if (objKey is not None):
        objKey = conditions.get('name')
        ll.append(objKey)
      ...
      if (objKey is not None):
        result = dataDict.get('guiTasks').get(objKey)
        if (result is None):
          root = self
          root.refreshTopObjects('ccpnmr.gui.Task')
          result = dataDict.get('guiTasks').get(objKey)
  ...
  def findFirstWindowStore(self, **conditions):
    """
    FindFirst for memops.Implementation.MemopsRoot.windowStores
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
      ...
      if (objKey is not None):
        result = dataDict.get('windowStores').get(objKey)
        if (result is None):
          root = self
          root.refreshTopObjects('ccpnmr.gui.Window')
          result = dataDict.get('windowStores').get(objKey)
  ...
  def getCurrentGuiTask(self):
    """
    Get for memops.Implementation.MemopsRoot.currentGuiTask
    """
    dataDict = self.__dict__
  ...
  def getCurrentWindowStore(self):
    """
    Get for memops.Implementation.MemopsRoot.currentWindowStore
    """
    dataDict = self.__dict__
  ...
  def getGuiTasks(self):
    """
    Get for memops.Implementation.MemopsRoot.guiTasks
    """
    dataDict = self.__dict__
    root = self
    root.refreshTopObjects('ccpnmr.gui.Task')
    tempVar = dataDict.get('guiTasks').values()
    result = frozenset(tempVar)
    return result
  ...
  def getWindowStores(self):
    """
    Get for memops.Implementation.MemopsRoot.windowStores
    """
    dataDict = self.__dict__
    root = self
    root.refreshTopObjects('ccpnmr.gui.Window')
    tempVar = dataDict.get('windowStores').values()
    result = frozenset(tempVar)
    return result
  ...
  get_ID = ImplementationObject.get_ID
  
  def get_lastId(self):
    """
    Get for memops.Implementation.MemopsRoot._lastId
    """
    dataDict = self.__dict__
    result = dataDict.get('_lastId')
    return result
  ...
  def importData(self, filePath):
    ...
    undo = self.root._undo
    if undo is not None:
       undo.newItem(result.delete, self.importData, redoArgs=(filePath,))
    return result
  ...
  def newAffiliationStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Affiliation import AffiliationStore
  ...
  def newAnnealProtocolStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.molsim.AnnealProtocol import AnnealProtocolStore
  ...
  def newAnnotationStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Annotation import AnnotationStore
  ...
  def newChemCompCharge(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemCompCharge import ChemCompCharge
  ...
  def newChemCompCoord(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemCompCoord import ChemCompCoord
  ...
  def newChemElementStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemElement import ChemElementStore
  ...
  def newCitationStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Citation import CitationStore
  ...
  def newDangleStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.cambridge.Dangle import DangleStore
  ...
  def newDataLocationStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.DataLocation import DataLocationStore
  ...
  def newDatabase(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.DbRef import Database
    return Database(self, **attrlinks)
  
  def newGuiTask(self, **attrlinks):
    """
    Factory function to create ccpnmr.gui.Task.GuiTask
    """
    from ccpnmodel.ccpncore.api.ccpnmr.gui.Task import GuiTask
    return GuiTask(self, **attrlinks)
  ...
  def newHaddockProject(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.utrecht.Haddock import HaddockProject
  ...
  def newInstrumentStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Instrument import InstrumentStore
  ...
  def newKeywordDefinitionStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.KeywordDefinition import KeywordDefinitionStore
  ...
  def newLabeledMolecule(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.LabeledMolecule import LabeledMolecule
  ...
  def newLabelingScheme(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemCompLabel import LabelingScheme
  ...
  def newMethodStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Method import MethodStore
  ...
  def newMolSystem(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.MolSystem import MolSystem
    return MolSystem(self, **attrlinks)
  
  def newMolSystemSymmetrySet(self, **attrlinks):
    """
    Factory function to create ccp.molecule.Symmetry.MolSystemSymmetrySet
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.Symmetry import MolSystemSymmetrySet
  ...
  def newNmrCalcStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrCalc import NmrCalcStore
  ...
  def newNmrConstraintStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrConstraint import NmrConstraintStore
  ...
  def newNmrEntryStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrEntry import NmrEntryStore
  ...
  def newNmrExpPrototype(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrExpPrototype import NmrExpPrototype
  ...
  def newNmrReferenceStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrReference import NmrReferenceStore
  ...
  def newNonStdChemComp(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemComp import NonStdChemComp
  ...
  def newRefSampleComponentStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.lims.RefSampleComponent import RefSampleComponentStore
  ...
  def newSampleStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.lims.Sample import SampleStore
  ...
  def newStdChemComp(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.ChemComp import StdChemComp
  ...
  def newStereochemistryStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.Stereochemistry import StereochemistryStore
  ...
  def newStructureEnsemble(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.MolStructure import StructureEnsemble
  ...
  def newTaxonomy(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.general.Taxonomy import Taxonomy
  ...
  def newValidationStore(self, **attrlinks):
    ...
    """
    from ccpnmodel.ccpncore.api.ccp.molecule.Validation import ValidationStore
    return ValidationStore(self, **attrlinks)
  
  def newWindowStore(self, **attrlinks):
    """
    Factory function to create ccpnmr.gui.Window.WindowStore
    """
    from ccpnmodel.ccpncore.api.ccpnmr.gui.Window import WindowStore
    return WindowStore(self, **attrlinks)
  
  def newWmsProtocol(self, **attrlinks):
    """
    Factory function to create cambridge.WmsProtocol.WmsProtocol
    """
    from ccpnmodel.ccpncore.api.cambridge.WmsProtocol import WmsProtocol
  ...
  def refreshTopObjects(self, packageName):
    ...
    for repository in repositories:
      ...
      fileSuffix = ApiPath.fileSuffix
      lenSuffix = ApiPath.lenFileSuffix
      sep = ApiPath.keySep
  ...
  def setAccessControlOn(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAccessControlOn, self.setAccessControlOn,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentAffiliationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentAffiliationStore, self.setCurrentAffiliationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentAnnealProtocolStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentAnnealProtocolStore, self.setCurrentAnnealProtocolStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentAnnotationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentAnnotationStore, self.setCurrentAnnotationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentChemComp(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentChemComp, self.setCurrentChemComp,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentChemCompCharge(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentChemCompCharge, self.setCurrentChemCompCharge,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentChemCompCoord(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentChemCompCoord, self.setCurrentChemCompCoord,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentChemElementStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentChemElementStore, self.setCurrentChemElementStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentCitationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentCitationStore, self.setCurrentCitationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentDangleStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentDangleStore, self.setCurrentDangleStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentDataLocationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentDataLocationStore, self.setCurrentDataLocationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentDatabase(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentDatabase, self.setCurrentDatabase,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentGroupName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentGroupName, self.setCurrentGroupName,
                      undoArgs=(currentValue,), redoArgs=(value,))

  def setCurrentGuiTask(self, value):
    """
    Set for memops.Implementation.MemopsRoot.currentGuiTask
    """
    dataDict = self.__dict__
    if (value is not None):
      from ccpnmodel.ccpncore.api.ccpnmr.gui.Task import GuiTask as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setCurrentGuiTask:
         value is not of class ccpnmr.gui.Task.GuiTask""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('currentGuiTask')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setCurrentGuiTask')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentGuiTask, self.setCurrentGuiTask,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentHaddockProject(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentHaddockProject, self.setCurrentHaddockProject,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentInstrumentStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentInstrumentStore, self.setCurrentInstrumentStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentKeywordDefinitionStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentKeywordDefinitionStore, self.setCurrentKeywordDefinitionStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentLabeledMolecule(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentLabeledMolecule, self.setCurrentLabeledMolecule,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentLabelingScheme(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentLabelingScheme, self.setCurrentLabelingScheme,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentMethodStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentMethodStore, self.setCurrentMethodStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentMolSystem(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentMolSystem, self.setCurrentMolSystem,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentMolSystemSymmetrySet(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentMolSystemSymmetrySet, self.setCurrentMolSystemSymmetrySet,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentMolecule(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentMolecule, self.setCurrentMolecule,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrCalcStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrCalcStore, self.setCurrentNmrCalcStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrConstraintStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrConstraintStore, self.setCurrentNmrConstraintStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrEntryStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrEntryStore, self.setCurrentNmrEntryStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrExpPrototype(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrExpPrototype, self.setCurrentNmrExpPrototype,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrProject(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrProject, self.setCurrentNmrProject,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentNmrReferenceStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentNmrReferenceStore, self.setCurrentNmrReferenceStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentRefSampleComponentStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentRefSampleComponentStore, self.setCurrentRefSampleComponentStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentSampleStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentSampleStore, self.setCurrentSampleStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentStereochemistryStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentStereochemistryStore, self.setCurrentStereochemistryStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentStructureEnsemble(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentStructureEnsemble, self.setCurrentStructureEnsemble,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentTaxonomy(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentTaxonomy, self.setCurrentTaxonomy,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentUserId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentUserId, self.setCurrentUserId,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentValidationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentValidationStore, self.setCurrentValidationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))

  def setCurrentWindowStore(self, value):
    """
    Set for memops.Implementation.MemopsRoot.currentWindowStore
    """
    dataDict = self.__dict__
    if (value is not None):
      from ccpnmodel.ccpncore.api.ccpnmr.gui.Window import WindowStore as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setCurrentWindowStore:
         value is not of class ccpnmr.gui.Window.WindowStore""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('currentWindowStore')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    dataDict['currentWindowStore'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setCurrentWindowStore')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentWindowStore, self.setCurrentWindowStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCurrentWmsProtocol(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCurrentWmsProtocol, self.setCurrentWmsProtocol,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setOverride(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setOverride, self.setOverride,
                      undoArgs=(currentValue,), redoArgs=(value,))

  set_ID = ImplementationObject.set_ID
  
  def set_lastId(self, value):
    """
    Set for memops.Implementation.MemopsRoot._lastId
    """
    dataDict = self.__dict__
    if (isinstance(value, Int.PythonType)):
      pass
  ...
  def sortedGuiTasks(self):
    """
    Sorted for memops.Implementation.MemopsRoot.guiTasks
    """
    dataDict = self.__dict__
    root = self
    root.refreshTopObjects('ccpnmr.gui.Task')
    sortdd = dataDict.get('guiTasks')
  ...
  def sortedWindowStores(self):
    """
    Sorted for memops.Implementation.MemopsRoot.windowStores
    """
    dataDict = self.__dict__
    root = self
    root.refreshTopObjects('ccpnmr.gui.Window')
    sortdd = dataDict.get('windowStores')
  ...
  _ID = ImplementationObject._ID
  
  _lastId = property(get_lastId, set_lastId, None,
  r"""Last ID used among in-package descendants of MemopsRoot
  """)
  ...
  currentGuiTask = property(getCurrentGuiTask, setCurrentGuiTask, None,
  r"""current guiTask - may be reset by implementation.
  """)
  ...
  currentWindowStore = property(getCurrentWindowStore, setCurrentWindowStore, None,
  r"""current windowStore - may be reset by implementation.
  """)
  ...
  guiTasks = property(getGuiTasks,  None, None,
  r"""child link
  """)
  ...
  windowStores = property(getWindowStores,  None, None,
  r"""child link
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.MemopsRoot', MemopsRoot)

###############################################################################
class PackageLocator(ImplementationObject):
  r"""Storage locations for one or more packages
  """
  #   from data model element memops.Implementation.PackageLocator
  _metaclass = metaPackage.getElement('PackageLocator')
  _packageName = 'memops.Implementation'
  _packageShortName = 'IMPL'
  _fieldNames = ('_ID', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'targetName', 'memopsRoot', 'parent', 'repositories', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('memops.Implementation.PackageLocator', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in memops.Implementation.PackageLocator.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for memops.Implementation.PackageLocator:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    memopsRoot = dataDict.get('memopsRoot')
    if (not (memopsRoot in objsToBeUnDeleted)):

      childrenDict = memopsRoot.__dict__.get('packageLocators')
      objKey = dataDict.get('targetName')
      if (objKey is None):
    ...
    for repository in dataDict.get('repositories'):
      if (not (repository in objsToBeUnDeleted)):
        stored = repository.__dict__.get('stored')
        stored.add(self)
  ...
  def addRepository(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRepositories, self.addRepository,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeRepository(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRepositories, self.removeRepository,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setRepositories(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRepositories, self.setRepositories,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.PackageLocator', PackageLocator)

###############################################################################
class Repository(ImplementationObject):
  r"""Data repository - database, directory, or server, where data are stored
  """
  #   from data model element memops.Implementation.Repository
  _metaclass = metaPackage.getElement('Repository')
  _packageName = 'memops.Implementation'
  _packageShortName = 'IMPL'
  _fieldNames = ('_ID', 'className', 'fieldNames', 'format', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'url', 'memopsRoot', 'parent', 'root', 'stored', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('memops.Implementation.Repository', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in memops.Implementation.Repository.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for memops.Implementation.Repository:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (memopsRoot in objsToBeUnDeleted)):
      ...
      childrenDict = memopsRoot.__dict__.get('repositories')
      objKey = dataDict.get('name')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['name'])""" % self.qualifiedName
    ...
    for stored in dataDict.get('stored'):
      if (not (stored in objsToBeUnDeleted)):
        repositories = stored.__dict__.get('repositories')
  ...
  def addStored(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStored, self.addStored,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def getFileLocation(self, packageName):
    ...
    if protocol == 'file':
      from ccpn.util import Path
      result = Path.joinPath(url.getDataLocation(), Path.CCPN_API_DIRECTORY,  *packageName.split('.'))
  ...
  def removeStored(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStored, self.removeStored,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setFormat(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setFormat, self.setFormat,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setStored(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStored, self.setStored,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('memops.Implementation.Repository', Repository)
