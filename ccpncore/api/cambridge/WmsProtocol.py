...
class EnumValue(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'label', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'value', 'interfaceParameter', 'parent', 'root', 'topObject',)
...
class InterfaceObject(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'col', 'colspan', 'fieldNames', 'inConstructor', 'interfaceGroup', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'row', 'rowspan', 'root', 'topObject',)
...
class ProtocolAccess(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'localUserName', 'metaclass', 'packageName', 'packageShortName', 'password', 'qualifiedName', 'serial', 'userName', 'parent', 'protocolService', 'root', 'topObject',)
...
class ProtocolInterface(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'info', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'title', 'interfaceLabels', 'interfaceParameters', 'parent', 'root', 'topObject', 'wmsProtocol',)
  ...
  def findAllInterfaceLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'col', 'colspan', 'interfaceGroup', 'label', 'row', 'rowspan', 'serial', 'protocolInterface',))
  ...
  def findAllInterfaceParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'col', 'colspan', 'hicard', 'interfaceGroup', 'isEditable', 'isOrdered', 'locard', 'row', 'rowspan', 'serial', 'protocolInterface', 'protocolParameter',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
run, and set it in NmrCalc.
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'defaultStrings', 'fieldNames', 'hicard', 'inConstructor', 'ioRole', 'isDeleted', 'locard', 'metaclass', 'name', 'packageName', 'packageShortName', 'paramType', 'qualifiedName', 'serial', 'container', 'content', 'interfaceParameters', 'parent', 'root', 'topObject', 'wmsProtocol',)
  ...
  def findAllContent(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'hicard', 'ioRole', 'locard', 'name', 'paramType', 'serial', 'container', 'wmsProtocol',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class ProtocolService(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'login', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'result', 'run', 'serial', 'status', 'url', 'parent', 'protocolAccesss', 'root', 'topObject', 'wmsProtocol',)
  ...
  def findAllProtocolAccesss(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'localUserName', 'password', 'serial', 'userName', 'protocolService',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class WmsProtocol(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllProtocolInterfaces(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'info', 'name', 'title', 'wmsProtocol',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllProtocolServices(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'login', 'result', 'run', 'serial', 'status', 'url', 'wmsProtocol',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class InterfaceParameter(InterfaceObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'col', 'colspan', 'defaultStrings', 'fieldNames', 'hicard', 'inConstructor', 'interfaceGroup', 'isDeleted', 'isEditable', 'isOrdered', 'locard', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'row', 'rowspan', 'serial', 'enumValues', 'parent', 'protocolInterface', 'protocolParameter', 'root', 'topObject',)
  ...
  def findAllEnumValues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'label', 'serial', 'value', 'interfaceParameter',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class InterfaceLabel(InterfaceObject):
  ...
  _packageName = 'cambridge.WmsProtocol'
  _packageShortName = 'WMSP'
  _fieldNames = ('_ID', 'applicationData', 'className', 'col', 'colspan', 'fieldNames', 'inConstructor', 'interfaceGroup', 'isDeleted', 'label', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'row', 'rowspan', 'serial', 'parent', 'protocolInterface', 'root', 'topObject',)
