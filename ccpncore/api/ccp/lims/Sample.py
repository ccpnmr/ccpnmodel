...
class AbstractSample(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'details', 'fieldNames', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'name', 'packageName', 'packageShortName', 'ph', 'qualifiedName', 'serial', 'parent', 'root', 'sampleComponents', 'sampleStore', 'topObject',)
  ...
  def findAllSampleComponents(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'concentration', 'concentrationError', 'concentrationUnit', 'details', 'labeling', 'name', 'purity', 'role', 'container', 'sample',))
  ...
  def getSerial(self):
    """
    Get for ccp.lims.Sample.AbstractSample.serial
    """
    dataDict = self.__dict__
    result = dataDict.get('serial')
    return result
  ...
  def setName(self, value):
    ...
    if (notOverride):
      ...
      if (notInConstructor):
        if (value is not None):
          if (not (self.sampleStore.findAllSamples(name=value) in (set(), set((self,))))):
            raise ApiError("""%s.setName:
             name constraint name_uniquely_identifies_Sample violated by value""" % self.qualifiedName
             + ": %s" % (value,)
            )
  ...
  def setSerial(self, value):
    """
    Set for ccp.lims.Sample.AbstractSample.serial
    """
    dataDict = self.__dict__
    ...
    parent = dataDict.get('sampleStore')
    oldSerial = parent.__dict__.get('_serialDict').get('samples')
    if (value < 0):
      value = (oldSerial + 1)
      parent.__dict__.get('_serialDict')['samples'] = value
...
the contents of the sample.
  ...
  _packageName = 'ccp.lims.Sample'
  _packageShortName = 'SAM'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'chainCodes', 'className', 'concentration', 'concentrationError', 'concentrationUnit', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'labeling', 'metaclass', 'name', 'packageName', 'packageShortName', 'purity', 'qualifiedName', 'role', 'container', 'contents', 'parent', 'refComponent', 'root', 'sample', 'spectrumHits', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.lims.Sample.SampleComponent.__init__")
        del dataDict['inConstructor']
        raise
      ...
      if (value is not None):
        if (isinstance(value, ccpnmodel.ccpncore.api.memops.Implementation.String.PythonType)):
          ...
          raise ApiError("""%s.checkValid: concentrationUnit:
           ccp.lims.Sample.ConcentrationUnit input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
        ...
        if (_lenValue > 32):
          raise ApiError("""%s.checkValid: concentrationUnit:
           ccp.lims.Sample.ConcentrationUnit maximum length is 32 violated by value""" % self.qualifiedName
           + ": %s" % (value,)
          )

        if (_lenValue < 1):
          raise ApiError("""%s.checkValid: concentrationUnit:
           ccp.lims.Sample.ConcentrationUnit: Empty string not allowed""" % self.qualifiedName
           + ": %s" % (value,)
          )
  ...
  def findAllSpectrumHits(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'concentration', 'concentrationError', 'concentrationUnit', 'details', 'figureOfMerit', 'isConfirmed', 'meritCode', 'normalisedChange', 'sampledDimension', 'sampledPoint', 'substanceName', 'dataSource',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class SampleStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.lims.Sample.SampleStore.__init__")
        del dataDict['inConstructor']
        raise

      serialDict = {}
      serialDict['samples'] = 0
  ...
  def findAllSamples(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'details', 'ionicStrength', 'isHazardous', 'isVirtual', 'name', 'ph', 'serial', 'sampleStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
located in an Holder.
  ...
  _packageName = 'ccp.lims.Sample'
  _packageShortName = 'SAM'
  _fieldNames = ('_ID', 'amount', 'amountUnit', 'applicationData', 'batchIdentifier', 'ccpnInternalData', 'className', 'colPosition', 'creationDate', 'details', 'fieldNames', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'name', 'packageName', 'packageShortName', 'ph', 'plateIdentifier', 'qualifiedName', 'rowPosition', 'serial', 'subPosition', 'nmrConstraintStore', 'nmrExperiments', 'parent', 'root', 'sampleComponents', 'sampleStore', 'sampledDataDims', 'spectrumHits', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.lims.Sample.Sample.__init__")
        del dataDict['inConstructor']
        raise
      ...
      if (notOverride):
        if (dataDict.get('serial') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % (parent, 'ccp.lims.Sample.Sample')
          )
      ...
      if (value is not None):
        if (isinstance(value, ccpnmodel.ccpncore.api.memops.Implementation.String.PythonType)):
          ...
          raise ApiError("""%s.checkValid: amountUnit:
           ccp.lims.Sample.AmountUnit input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
        ...
        if (_lenValue > 32):
          raise ApiError("""%s.checkValid: amountUnit:
           ccp.lims.Sample.AmountUnit maximum length is 32 violated by value""" % self.qualifiedName
           + ": %s" % (value,)
          )

        if (_lenValue < 1):
          raise ApiError("""%s.checkValid: amountUnit:
           ccp.lims.Sample.AmountUnit: Empty string not allowed""" % self.qualifiedName
           + ": %s" % (value,)
          )
  ...
  def findAllSampledDataDims(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'conditionVaried', 'details', 'dim', 'fileDim', 'gaussianBroadening', 'isComplex', 'lorentzianBroadening', 'numPoints', 'shapeSerial', 'sineWindowShift', 'unit', 'windowFunction', 'dataSource', 'expDim', 'predictMethod',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  getSerial = AbstractSample.getSerial
  ...
  setSerial = AbstractSample.setSerial
...
its  physical properties : dimensions, color,...
  ...
  _packageName = 'ccp.lims.Sample'
  _packageShortName = 'SAM'
  _fieldNames = ('_ID', 'a', 'alpha', 'amount', 'amountUnit', 'applicationData', 'b', 'batchIdentifier', 'beta', 'c', 'ccpnInternalData', 'className', 'colPosition', 'colour', 'creationDate', 'crystalType', 'details', 'fieldNames', 'gamma', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'morphology', 'name', 'packageName', 'packageShortName', 'ph', 'plateIdentifier', 'qualifiedName', 'rowPosition', 'serial', 'spaceGroup', 'subPosition', 'x', 'y', 'z', 'nmrConstraintStore', 'nmrExperiments', 'parent', 'root', 'sampleComponents', 'sampleStore', 'sampledDataDims', 'spectrumHits', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.lims.Sample.CrystalSample.__init__")
        del dataDict['inConstructor']
        raise
      ...
      if (notOverride):
        if (dataDict.get('serial') is None):
          ...
          raise ApiError("""%s.__init__:
           Cannot pass in explicit serial if not reading""" % self.qualifiedName
           + ": %s:%s" % (parent, 'ccp.lims.Sample.CrystalSample')
          )
