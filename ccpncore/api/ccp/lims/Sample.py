...
Autogenerated by PyFileApiGen on Mon Oct 31 09:10:35 2016
...
class AbstractSample(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'details', 'fieldNames', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'name', 'packageName', 'packageShortName', 'ph', 'qualifiedName', 'parent', 'root', 'sampleComponents', 'sampleStore', 'topObject',)
...
class SampleStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllSamples(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'details', 'ionicStrength', 'isHazardous', 'isVirtual', 'name', 'ph', 'sampleStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
located in an Holder.
  ...
  _packageName = 'ccp.lims.Sample'
  _packageShortName = 'SAM'
  _fieldNames = ('_ID', 'amount', 'amountUnit', 'applicationData', 'batchIdentifier', 'ccpnInternalData', 'className', 'colPosition', 'creationDate', 'details', 'fieldNames', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'name', 'packageName', 'packageShortName', 'ph', 'plateIdentifier', 'qualifiedName', 'rowPosition', 'subPosition', 'nmrConstraintStore', 'nmrExperiments', 'parent', 'root', 'sampleComponents', 'sampleStore', 'sampledDataDims', 'spectrumHits', 'topObject',)
...
its  physical properties : dimensions, color,...
  ...
  _packageName = 'ccp.lims.Sample'
  _packageShortName = 'SAM'
  _fieldNames = ('_ID', 'a', 'alpha', 'amount', 'amountUnit', 'applicationData', 'b', 'batchIdentifier', 'beta', 'c', 'ccpnInternalData', 'className', 'colPosition', 'colour', 'creationDate', 'crystalType', 'details', 'fieldNames', 'gamma', 'inConstructor', 'ionicStrength', 'isDeleted', 'isHazardous', 'isVirtual', 'metaclass', 'morphology', 'name', 'packageName', 'packageShortName', 'ph', 'plateIdentifier', 'qualifiedName', 'rowPosition', 'spaceGroup', 'subPosition', 'x', 'y', 'z', 'nmrConstraintStore', 'nmrExperiments', 'parent', 'root', 'sampleComponents', 'sampleStore', 'sampledDataDims', 'spectrumHits', 'topObject',)
