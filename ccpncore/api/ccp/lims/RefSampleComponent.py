...
Cell, Substance and Composite.
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'labeling', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'synonyms', 'userCode', 'componentDbRefs', 'compositeElements', 'labels', 'naturalSource', 'nmrConstraintStore', 'parent', 'refSampleComponentStore', 'root', 'topObject',)
  ...
  def findAllComponentDbRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'alignBegin', 'alignEnd', 'dbRefAlignBegin', 'dbRefAlignEnd', 'details', 'serial', 'threadingProg', 'threadingScore', 'component', 'dbRef',))
  ...
  def findAllCompositeElements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'serial', 'stoichiometry', 'component', 'composite',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'elementName', 'incorporation', 'isUniform', 'labelName', 'labelType', 'massNumber', 'numInstances', 'serial', 'component',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class ComponentDbRef(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'alignBegin', 'alignEnd', 'applicationData', 'className', 'dbRefAlignBegin', 'dbRefAlignEnd', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'threadingProg', 'threadingScore', 'component', 'dbRef', 'parent', 'root', 'topObject',)
...
class CompositeElement(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stoichiometry', 'component', 'composite', 'interactions', 'parent', 'root', 'topObject',)
  ...
  def findAllInteractions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'affinity', 'assessmentMethod', 'details', 'interactionType', 'serial', 'composite',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class CompositeInteraction(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'affinity', 'applicationData', 'assessmentMethod', 'className', 'details', 'fieldNames', 'inConstructor', 'interactionType', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'composite', 'elements', 'parent', 'root', 'topObject',)
...
atoms with these names.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'atomNames', 'className', 'elementSymbol', 'fieldNames', 'inConstructor', 'incorporation', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'molResidues', 'parent', 'root', 'specificLabelGroup', 'topObject',)
...
given in the Label class, as both are valid together.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'elementName', 'fieldNames', 'inConstructor', 'incorporation', 'isDeleted', 'isUniform', 'labelName', 'labelType', 'massNumber', 'metaclass', 'numInstances', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'component', 'parent', 'root', 'topObject',)
...
consecutive serials.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'endSeqId', 'featureType', 'fieldNames', 'inConstructor', 'isDeleted', 'length', 'metaclass', 'name', 'ordering', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'startSeqId', 'status', 'molComponent', 'parent', 'refMolComponent', 'root', 'topObject',)
...
class RefSampleComponentStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllComponents(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'labeling', 'name', 'userCode', 'naturalSource', 'nmrConstraintStore', 'refSampleComponentStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
as both are valid together.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'fraction', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'isotopeLabels', 'molComponent', 'parent', 'root', 'topObject',)
...
so is lysozyme.
  ...
  def findAllMolCompFeatures(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'endSeqId', 'featureType', 'name', 'ordering', 'serial', 'startSeqId', 'status', 'molComponent', 'refMolComponent',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllSpecificLabelGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'fraction', 'serial', 'molComponent',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
plasmids.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'assessmentMethod', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'labeling', 'metaclass', 'molecularMass', 'molecularMassMethod', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'synonyms', 'userCode', 'componentDbRefs', 'compositeElements', 'elements', 'interactions', 'labels', 'naturalSource', 'nmrConstraintStore', 'parent', 'refSampleComponentStore', 'root', 'topObject',)
...
such as a PCR-primer used to amplify nucleic acid fragments.
  ...
  _packageName = 'ccp.lims.RefSampleComponent'
  _packageShortName = 'REFS'
  _fieldNames = ('_ID', 'applicationData', 'atomCount', 'bondCount', 'casNum', 'className', 'details', 'direction', 'empiricalFormula', 'fieldNames', 'hBondAcceptorCount', 'hBondDonorCount', 'inChi', 'inConstructor', 'isDeleted', 'isUniversal', 'labeling', 'logPartitionCoefficient', 'meltingTemperature', 'metaclass', 'molType', 'molecularMass', 'name', 'packageName', 'packageShortName', 'polarSurfaceArea', 'qualifiedName', 'ringCount', 'seqDetails', 'seqString', 'smiles', 'synonyms', 'userCode', 'componentDbRefs', 'compositeElements', 'labeledMixture', 'labels', 'molCompFeatures', 'molecule', 'naturalSource', 'nmrConstraintStore', 'parent', 'refMolCompFeatures', 'refSampleComponentStore', 'root', 'specificLabelGroups', 'topObject',)
