...
Autogenerated by PyFileApiGen on Mon May 16 03:11:01 2016
...
class Run(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  def getOperator(self):
    ...
    """
    dataDict = self.__dict__
    result = cccpnmodel.cpncore.api.ccp.general.Affiliation.Person.getByKey(self.root, (self.affiliationStoreName, self.operatorSerial))
    return result
