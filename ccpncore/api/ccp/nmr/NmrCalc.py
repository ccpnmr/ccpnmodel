...
Autogenerated by PyFileApiGen on Sat Jun 25 07:28:01 2016
...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.nmr.NmrCalc')
...
parameterGroup (data) link (but different serials).
  """
  #   from data model element ccp.nmr.NmrCalc.Data
  _metaclass = metaPackage.getElement('Data')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
  ...
  def addRunParameter(self, value):
    ...
    if (notIsReading):
      undoValueDict = {value:value.data}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addRunParameter, undoArgs=(undoValueDict, 'data'),  redoArgs=(value,))
  ...
  def findAllRunParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'booleanValue', 'code', 'floatValue', 'intValue', 'ioRole', 'name', 'serial', 'textValue', 'data', 'run',))
  ...
  def removeRunParameter(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRunParameters, self.removeRunParameter,
  ...
  def setIoRole(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIoRole, self.setIoRole,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setParameterGroup(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setParameterGroup, self.setParameterGroup,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setRunParameters(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.data) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setRunParameters, undoArgs=(undoValueDict, 'data'),  redoArgs=(values,))
...
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.Data', Data)
...
a restraint derived from relaxation measurements.
  """
  #   from data model element ccp.nmr.NmrCalc.EnergyTermParameter
  _metaclass = metaPackage.getElement('EnergyTermParameter')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'value', 'energyTerm', 'parent', 'root', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.nmr.NmrCalc.EnergyTermParameter', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.EnergyTermParameter.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.EnergyTermParameter:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    if (not (energyTerm in objsToBeUnDeleted)):
      ...
      childrenDict = energyTerm.__dict__.get('energyTermParameters')
      objKey = dataDict.get('code')
      if (objKey is None):
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.EnergyTermParameter', EnergyTermParameter)

###############################################################################
class NmrCalcStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""TopObject for NmrCalc package
  """
  #   from data model element ccp.nmr.NmrCalc.NmrCalcStore
  _metaclass = metaPackage.getElement('NmrCalcStore')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'nmrProjectName', 'packageName', 'packageShortName', 'qualifiedName', 'validationStoreName', 'activeRepositories', 'memopsRoot', 'nmrProject', 'packageLocator', 'parent', 'root', 'runs', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.NmrCalcStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.NmrCalcStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.NmrCalcStore:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = memopsRoot.__dict__.get('nmrCalcStores')
    ll = list()
    objKey = dataDict.get('nmrProjectName')
    ll.append(objKey)
    if (objKey is not None):
  ...
  def findAllRuns(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'affiliationStoreName', 'annealProtocolApp', 'annealProtocolCode', 'annealProtocolStoreName', 'details', 'methodStoreName', 'operatorSerial', 'serial', 'softwareName', 'softwareVersion', 'status', 'structureGenerationSerial', 'wmsProtocolName', 'masterRun', 'nmrCalcStore', 'operator',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def setNmrProject(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrProject, self.setNmrProject,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setValidationStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidationStore, self.setValidationStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setValidationStoreName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidationStoreName, self.setValidationStoreName,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.NmrCalcStore', NmrCalcStore)

###############################################################################
class Run(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Calculation run, collecting input and output.
  """
  #   from data model element ccp.nmr.NmrCalc.Run
  _metaclass = metaPackage.getElement('Run')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'affiliationStoreName', 'annealProtocolApp', 'annealProtocolCode', 'annealProtocolStoreName', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'methodStoreName', 'operatorSerial', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'softwareName', 'softwareVersion', 'status', 'structureGenerationSerial', 'wmsProtocolName', 'annealProtocol', 'data', 'derivedRuns', 'inputs', 'masterRun', 'nmrCalcStore', 'operator', 'outputs', 'parent', 'root', 'runParameters', 'software', 'structureGeneration', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.Run', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.Run.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.Run:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = nmrCalcStore.__dict__.get('runs')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    for derivedRun in dataDict.get('derivedRuns'):
      if (not (derivedRun in objsToBeUnDeleted)):
        if (derivedRun.__dict__.get('masterRun') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Run object derivedRuns link - backLink Run.masterRun is not None""" % self.qualifiedName
          )

        derivedRun.__dict__['masterRun'] = self

    masterRun = dataDict.get('masterRun')
    if ((masterRun is not None and not (masterRun in objsToBeUnDeleted))):
      derivedRuns = masterRun.__dict__.get('derivedRuns')
      derivedRuns.add(self)
  ...
  def addDerivedRun(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.masterRun}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addDerivedRun, undoArgs=(undoValueDict, 'masterRun'),  redoArgs=(value,))
  ...
  def findAllData(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'details', 'ioRole', 'name', 'serial', 'parameterGroup', 'run',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def getAnnealProtocol(self):
    ...
    """
    dataDict = self.__dict__
    result = ccpnmodel.ccpncore.api.molsim.AnnealProtocol.AnnealProtocol.getByKey(self.root, (self.annealProtocolStoreName, self.annealProtocolApp, self.annealProtocolCode))
    return result
  ...
  def getOperator(self):
    ...
    """
    dataDict = self.__dict__
    result = cccpnmodel.ccpncore.api.ccp.general.Affiliation.Person.getByKey(self.root, (self.affiliationStoreName, self.operatorSerial))
    return result
  ...
  def getSoftware(self):
    ...
    """
    dataDict = self.__dict__
    result = ccpnmodel.ccpncore.api.ccp.general.Method.Software.getByKey(self.root, (self.methodStoreName, self.softwareName, self.softwareVersion))
    return result
  ...
  def getStructureGeneration(self):
    ...
    """
    dataDict = self.__dict__
    result = ccpnmodel.ccpncore.api.ccp.nmr.Nmr.StructureGeneration.getByKey(self.root, (self.nmrCalcStore.nmrProjectName, self.structureGenerationSerial))
    return result
  ...
  def removeDerivedRun(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDerivedRuns, self.removeDerivedRun,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setAffiliationStoreName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAffiliationStoreName, self.setAffiliationStoreName,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setAnnealProtocolApp(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAnnealProtocolApp, self.setAnnealProtocolApp,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setAnnealProtocolCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAnnealProtocolCode, self.setAnnealProtocolCode,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setAnnealProtocolStoreName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAnnealProtocolStoreName, self.setAnnealProtocolStoreName,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setDerivedRuns(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.masterRun) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setDerivedRuns, undoArgs=(undoValueDict, 'masterRun'),  redoArgs=(values,))
  ...
  def setMasterRun(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMasterRun, self.setMasterRun,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setOperator(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setOperator, self.setOperator,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setOperatorSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setOperatorSerial, self.setOperatorSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setSoftwareVersion(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSoftwareVersion, self.setSoftwareVersion,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setStructureGenerationSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStructureGenerationSerial, self.setStructureGenerationSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setWmsProtocolName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setWmsProtocolName, self.setWmsProtocolName,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.Run', Run)

###############################################################################
class RunParameter(ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue):
  r"""Run parameter - mainly used for input parameters
  """
  #   from data model element ccp.nmr.NmrCalc.RunParameter
  _metaclass = metaPackage.getElement('RunParameter')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'code', 'fieldNames', 'floatValue', 'inConstructor', 'intValue', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'data', 'parent', 'root', 'run', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.RunParameter', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.RunParameter.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.RunParameter:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (run in objsToBeUnDeleted)):
      ...
      childrenDict = run.__dict__.get('runParameters')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    data = dataDict.get('data')
    if ((data is not None and not (data in objsToBeUnDeleted))):
      runParameters = data.__dict__.get('runParameters')
      runParameters.add(self)
  ...
  getBooleanValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.getBooleanValue
  ...
  getFloatValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.getFloatValue
  ...
  getIntValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.getIntValue
  ...
  getTextValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.getTextValue
  ...
  setBooleanValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.setBooleanValue
  ...
  setFloatValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.setFloatValue

  setIntValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.setIntValue
  ...
  setTextValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.setTextValue
  ...
  booleanValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.booleanValue
  ...
  floatValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.floatValue

  inConstructor = ccpnmodel.ccpncore.api.memops.Implementation.ComplexDataType.inConstructor

  intValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.intValue
  ...
  textValue = ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue.textValue
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.RunParameter', RunParameter)

###############################################################################
class TensorData(Data):
  r"""Data for orientation matrices, order tensors, etc.
  """
  #   from data model element ccp.nmr.NmrCalc.TensorData
  _metaclass = metaPackage.getElement('TensorData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'orientationMatrix', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.TensorData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.TensorData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.TensorData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (run in objsToBeUnDeleted)):
      ...
      childrenDict = run.__dict__.get('data')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    parameterGroup = dataDict.get('parameterGroup')
    if ((parameterGroup is not None and not (parameterGroup in objsToBeUnDeleted))):
      data = parameterGroup.__dict__.get('data')
      data.add(self)

    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of TensorData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )

        runParameter.__dict__['data'] = self
  ...
  def setOrientationMatrix(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setOrientationMatrix, self.setOrientationMatrix,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.TensorData', TensorData)

###############################################################################
class StructureEnsembleData(Data):
  r"""StructureEnsemble data for calculations
  """
  #   from data model element ccp.nmr.NmrCalc.StructureEnsembleData
  _metaclass = metaPackage.getElement('StructureEnsembleData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'ensembleId', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'modelSerials', 'molSystemCode', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'models', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'structureEnsemble', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.StructureEnsembleData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.StructureEnsembleData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.StructureEnsembleData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of StructureEnsembleData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def addModelSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setModelSerials, self.addModelSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllModels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'index', 'name', 'serial', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.append(v)
  ...
  def removeModelSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setModelSerials, self.removeModelSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setEnsembleId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setEnsembleId, self.setEnsembleId,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setModelSerials(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setModelSerials, self.setModelSerials,
  ...
  def setMolSystemCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMolSystemCode, self.setMolSystemCode,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.StructureEnsembleData', StructureEnsembleData)

###############################################################################
class FloatMatrixData(Data):
  r"""Floating point matrix data
  """
  #   from data model element ccp.nmr.NmrCalc.FloatMatrixData
  _metaclass = metaPackage.getElement('FloatMatrixData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'data', 'defaultValue', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'ndim', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'shape', 'size', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.FloatMatrixData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.FloatMatrixData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.FloatMatrixData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of FloatMatrixData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.FloatMatrixData', FloatMatrixData)

###############################################################################
class ConstraintStoreData(Data):
  r"""nmr Calculation data - ConstrantStore and sets of ConstraintLists
  """
  #   from data model element ccp.nmr.NmrCalc.ConstraintStoreData
  _metaclass = metaPackage.getElement('ConstraintStoreData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'constraintListSerials', 'constraintStoreSerial', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'constraintLists', 'nmrConstraintStore', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.ConstraintStoreData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.ConstraintStoreData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.ConstraintStoreData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ConstraintStoreData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def addConstraintList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintLists, self.addConstraintList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addConstraintListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintListSerials, self.addConstraintListSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllConstraintLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'origin', 'potentialType', 'serial', 'unit', 'usedForCalculation', 'conditionState', 'method', 'nmrConstraintStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.append(v)
  ...
  def getConstraintLists(self):
    ...
    if ncstore:
      ...
      if serials:
        result = tuple(ncstore.findFirstConstraintList(serial=x) for x in serials)
        result = tuple(x for x in result if x is not None)
      else:
  ...
  def removeConstraintListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintListSerials, self.removeConstraintListSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setConstraintListSerials(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintListSerials, self.setConstraintListSerials,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setConstraintLists(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintLists, self.setConstraintLists,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setConstraintStoreSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstraintStoreSerial, self.setConstraintStoreSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.ConstraintStoreData', ConstraintStoreData)

###############################################################################
class SpectrumData(Data):
  r"""Nmr PeakList data
  """
  #   from data model element ccp.nmr.NmrCalc.SpectrumData
  _metaclass = metaPackage.getElement('SpectrumData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'dataSourceSerial', 'details', 'experimentSerial', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'dataSource', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.SpectrumData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.SpectrumData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.SpectrumData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of SpectrumData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def setDataSource(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataSource, self.setDataSource,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setDataSourceSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataSourceSerial, self.setDataSourceSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setExperimentSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExperimentSerial, self.setExperimentSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.SpectrumData', SpectrumData)
...
parameters for successive phases of an annealing protocol.
  """
  #   from data model element ccp.nmr.NmrCalc.ParameterGroup
  _metaclass = metaPackage.getElement('ParameterGroup')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'data', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.ParameterGroup', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.ParameterGroup.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.ParameterGroup:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for data in dataDict.get('data'):
      if (not (data in objsToBeUnDeleted)):
        if (data.__dict__.get('parameterGroup') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ParameterGroup object data link - backLink Data.parameterGroup is not None""" % self.qualifiedName
          )

        data.__dict__['parameterGroup'] = self
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ParameterGroup object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def addData(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.parameterGroup}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addData, undoArgs=(undoValueDict, 'parameterGroup'),  redoArgs=(value,))
  ...
  def removeData(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setData, self.removeData,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setData(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.parameterGroup) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setData, undoArgs=(undoValueDict, 'parameterGroup'),  redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.ParameterGroup', ParameterGroup)

###############################################################################
class MolSystemData(Data):
  r"""Molsystem and Chain data for calculations
  """
  #   from data model element ccp.nmr.NmrCalc.MolSystemData
  _metaclass = metaPackage.getElement('MolSystemData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'chainCodes', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'molSystemCode', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'symmetrySetId', 'chains', 'molSystem', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'symmetrySet', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.MolSystemData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.MolSystemData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.MolSystemData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of MolSystemData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def setSymmetrySet(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setSymmetrySet')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSymmetrySet, self.setSymmetrySet,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setSymmetrySetId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSymmetrySetId, self.setSymmetrySetId,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.MolSystemData', MolSystemData)

###############################################################################
class MeasurementListData(Data):
  r"""Nmr.MeasurementList data.
  """
  #   from data model element ccp.nmr.NmrCalc.MeasurementListData
  _metaclass = metaPackage.getElement('MeasurementListData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'measurementListSerial', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'measurementList', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.MeasurementListData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.MeasurementListData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.MeasurementListData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of MeasurementListData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def setMeasurementList(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setMeasurementList')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMeasurementList, self.setMeasurementList,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMeasurementListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMeasurementListSerial, self.setMeasurementListSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.MeasurementListData', MeasurementListData)

###############################################################################
class ViolationListData(Data):
  r"""ViolationList used for data
  """
  #   from data model element ccp.nmr.NmrCalc.ViolationListData
  _metaclass = metaPackage.getElement('ViolationListData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'constraintStoreSerial', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'violationListSerial', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject', 'violationList',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.ViolationListData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.ViolationListData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.ViolationListData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ViolationListData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def getViolationList(self):
    ...
    """
    dataDict = self.__dict__
    result = ccpnmodel.ccpncore.api.ccp.nmr.NmrConstraint.ViolationList.getByKey(self.root, (self.constraintStoreSerial, self.violationListSerial))
    return result
  ...
  def setViolationList(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setViolationList')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setViolationList, self.setViolationList,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setViolationListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setViolationListSerial, self.setViolationListSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.ViolationListData', ViolationListData)

###############################################################################
class PeakListData(Data):
  r"""Nmr PeakList data
  """
  #   from data model element ccp.nmr.NmrCalc.PeakListData
  _metaclass = metaPackage.getElement('PeakListData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'dataSourceSerial', 'details', 'experimentSerial', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'peakListSerial', 'qualifiedName', 'serial', 'dataSource', 'parameterGroup', 'parent', 'peakList', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.PeakListData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.PeakListData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.PeakListData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of PeakListData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def setPeakList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPeakList, self.setPeakList,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setPeakListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPeakListSerial, self.setPeakListSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.PeakListData', PeakListData)

###############################################################################
class DerivedListData(Data):
  r"""Nmr.DerivedDataList data
  """
  #   from data model element ccp.nmr.NmrCalc.DerivedListData
  _metaclass = metaPackage.getElement('DerivedListData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'derivedDataListSerial', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'derivedDataList', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.DerivedListData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.DerivedListData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.DerivedListData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of DerivedListData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def setDerivedDataList(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setDerivedDataList')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDerivedDataList, self.setDerivedDataList,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setDerivedDataListSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDerivedDataListSerial, self.setDerivedDataListSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.DerivedListData', DerivedListData)

###############################################################################
class SpinSystemData(Data):
  r"""Nmr.SpinSystem data for calculations
  """
  #   from data model element ccp.nmr.NmrCalc.SpinSystemData
  _metaclass = metaPackage.getElement('SpinSystemData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'resonanceGroupSerials', 'serial', 'parameterGroup', 'parent', 'resonanceGroups', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.SpinSystemData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.SpinSystemData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.SpinSystemData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of SpinSystemData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def addResonanceGroupSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResonanceGroupSerials, self.addResonanceGroupSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllResonanceGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpCode', 'chainSerial', 'descriptor', 'details', 'linking', 'mainGroupSerial', 'molType', 'name', 'relativeOffset', 'residueType', 'secStrucCode', 'seqCode', 'seqInsertCode', 'serial', 'directNmrChain', 'nmrProject', 'residue',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeResonanceGroupSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResonanceGroupSerials, self.removeResonanceGroupSerial,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setResonanceGroupSerials(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResonanceGroupSerials, self.setResonanceGroupSerials,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.SpinSystemData', SpinSystemData)

###############################################################################
class ExternalData(Data):
  r"""Unit of data from external file
  """
  #   from data model element ccp.nmr.NmrCalc.ExternalData
  _metaclass = metaPackage.getElement('ExternalData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'dataLocationStoreName', 'dataStoreSerial', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'dataStore', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.ExternalData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.ExternalData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.ExternalData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ExternalData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.DataLocation import AbstractDataStore as importedType
        if (not isinstance(value, importedType)):
  ...
  def getDataStore(self):
    ...
    """
    dataDict = self.__dict__
    result = ccpnmodel.ccpncore.api.ccp.general.DataLocation.AbstractDataStore.getByKey(self.root, (self.dataLocationStoreName, self.dataStoreSerial))
    return result
  ...
  def setDataLocationStoreName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataLocationStoreName, self.setDataLocationStoreName,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setDataStore(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataStore, self.setDataStore,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setDataStoreSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataStoreSerial, self.setDataStoreSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.ExternalData', ExternalData)

###############################################################################
class MolResidueData(Data):
  r"""MolSystem.Residue data for calculations
  """
  #   from data model element ccp.nmr.NmrCalc.MolResidueData
  _metaclass = metaPackage.getElement('MolResidueData')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'applicationData', 'chainCode', 'chainCodes', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'molSystemCode', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'residueSeqIds', 'serial', 'chain', 'chains', 'molSystem', 'parameterGroup', 'parent', 'residues', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.MolResidueData', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.MolResidueData.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.MolResidueData:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of MolResidueData object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def addResidue(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidues, self.addResidue,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addResidueSeqId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidueSeqIds, self.addResidueSeqId,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def checkValid(self, complete=False):
    ...
    # check explicit class constraints
    if (not (len(self.chainCodes) in (1,len(self.residueSeqIds)))):
      raise ApiError("""%s.checkValid:
       constraint Either_single_chain_code_or_residueSeqIds_match_chainCodes_one_to_one violated""" % self.qualifiedName
       + ": %s" % (self,)
      )
  ...
  def findAllResidues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'descriptor', 'details', 'linking', 'seqCode', 'seqId', 'seqInsertCode', 'chain', 'chainFragment',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeResidue(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidues, self.removeResidue,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeResidueSeqId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidueSeqIds, self.removeResidueSeqId,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setResidueSeqIds(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidueSeqIds, self.setResidueSeqIds,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setResidues(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setResidues, self.setResidues,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.MolResidueData', MolResidueData)

###############################################################################
class EnergyTerm(ConstraintStoreData):
  r"""Energy potential term used in Nmr simulation run
  """
  #   from data model element ccp.nmr.NmrCalc.EnergyTerm
  _metaclass = metaPackage.getElement('EnergyTerm')
  _packageName = 'ccp.nmr.NmrCalc'
  _packageShortName = 'CALC'
  _fieldNames = ('_ID', 'annealEnergyTermSerial', 'applicationData', 'className', 'code', 'constraintListSerials', 'constraintStoreSerial', 'details', 'fieldNames', 'inConstructor', 'ioRole', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'annealEnergyTerm', 'constraintLists', 'energyTermParameters', 'nmrConstraintStore', 'parameterGroup', 'parent', 'root', 'run', 'runParameters', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrCalc.EnergyTerm', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.nmr.NmrCalc.EnergyTerm.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrCalc.EnergyTerm:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for runParameter in dataDict.get('runParameters'):
      if (not (runParameter in objsToBeUnDeleted)):
        if (runParameter.__dict__.get('data') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of EnergyTerm object runParameters link - backLink RunParameter.data is not None""" % self.qualifiedName
          )
  ...
  def findAllEnergyTermParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'value', 'energyTerm',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def setAnnealEnergyTerm(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setAnnealEnergyTerm')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAnnealEnergyTerm, self.setAnnealEnergyTerm,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setAnnealEnergyTermSerial(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAnnealEnergyTermSerial, self.setAnnealEnergyTermSerial,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrCalc.EnergyTerm', EnergyTerm)
