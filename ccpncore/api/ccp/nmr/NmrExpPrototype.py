...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.nmr.NmrExpPrototype')

###############################################################################
class AtomSite(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
to a given nucleus is used for filtering during an experiment.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.AtomSite
  _metaclass = metaPackage.getElement('AtomSite')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopeCode', 'maxNumber', 'maxShift', 'metaclass', 'minNumber', 'minShift', 'name', 'numberStep', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'expGraphs', 'expMeasurements', 'expTransfers', 'isotope', 'nmrExpPrototype', 'parent', 'root', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.AtomSite', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.AtomSite.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.AtomSite:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    childrenDict = nmrExpPrototype.__dict__.get('atomSites')
    objKey = dataDict.get('serial')
    if (objKey is None):
    ...
    for expMeasurement in dataDict.get('expMeasurements'):
      if (not (expMeasurement in objsToBeUnDeleted)):
        atomSites = expMeasurement.__dict__.get('atomSites')
        atomSites.append(self)
  ...
  def addExpMeasurement(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpMeasurements, self.addExpMeasurement,
  ...
  def findAllExpGraphs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'peakSign', 'serial', 'nmrExpPrototype',))
  ...
  def findAllExpMeasurements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'measurementType', 'serial', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllExpTransfers(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'serial', 'transferToSelf', 'transferType', 'expGraph',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeExpMeasurement(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpMeasurements, self.removeExpMeasurement,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setExpMeasurements(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpMeasurements, self.setExpMeasurements,
  ...
  def setExpTransfers(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpTransfers, self.setExpTransfers,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setMaxNumber(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMaxNumber, self.setMaxNumber,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMaxShift(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMaxShift, self.setMaxShift,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMinNumber(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMinNumber, self.setMinNumber,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMinShift(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMinShift, self.setMinShift,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setNumberStep(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNumberStep, self.setNumberStep,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.AtomSite', AtomSite)

###############################################################################
class ExpGraph(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
molecule topologies giving rise to peaks of different sign.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpGraph
  _metaclass = metaPackage.getElement('ExpGraph')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'peakSign', 'qualifiedName', 'serial', 'atomSites', 'expMeasurements', 'expSteps', 'expTransfers', 'nmrExpPrototype', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.ExpGraph', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.ExpGraph.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.ExpGraph:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = nmrExpPrototype.__dict__.get('expGraphs')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def findAllAtomSites(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'isotopeCode', 'maxNumber', 'maxShift', 'minNumber', 'minShift', 'name', 'numberStep', 'serial', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllExpSteps(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'serial', 'stepNumber', 'expGraph', 'expMeasurement',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def setPeakSign(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPeakSign, self.setPeakSign,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.ExpGraph', ExpGraph)

###############################################################################
class ExpMeasurement(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
others are possible.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpMeasurement
  _metaclass = metaPackage.getElement('ExpMeasurement')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'atomSiteWeights', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'measurementType', 'metaclass', 'nucleusCode', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'atomSites', 'expGraphs', 'expSteps', 'nmrExpPrototype', 'parent', 'refExpDimRefs', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.ExpMeasurement', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.ExpMeasurement.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.ExpMeasurement:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = nmrExpPrototype.__dict__.get('expMeasurements')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    for atomSite in dataDict.get('atomSites'):
      if (not (atomSite in objsToBeUnDeleted)):
        expMeasurements = atomSite.__dict__.get('expMeasurements')
        expMeasurements.add(self)
  ...
  def addAtomSite(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSites, self.addAtomSite,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addAtomSiteWeight(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSiteWeights, self.addAtomSiteWeight,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (_lenValue > 1024):
        raise ApiError("""%s.checkValid: measurementType:
         ccp.nmr.NmrExpPrototype.ExpMeasurementType maximum length is 1024 violated by value""" % self.qualifiedName
         + ": %s" % (value,)
        )
      ...
      value = self.getNucleusCode()
      if (value is None):
        raise ApiError("""%s.checkValid: nucleusCode:
         value cannot be None""" % self.qualifiedName
         + ": %s" % (self,)
        )
  ...
  def findAllRefExpDimRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'axisCode', 'ccpnInternalData', 'constantTime', 'groupingId', 'serial', 'expMeasurement', 'refExpDim',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def getNucleusCode(self):
    """
    getter for derived attribute nucleusCode
    """
    dataDict = self.__dict__
    from ccpn.util import Constants
    emType = self.measurementType.lower()
    tag = Constants.measurementType2ElementCode.get(emType, emType)
    if tag == 'delay':
      result = tag
    else:
      records = [Constants.isotopeRecords.get(x.isotopeCode) for x in self.atomSites]
      if None in records:
        raise ValueError("Invalid NmrExpPrototype, unknown isotopeCode for atomSite at %s " % self)
      else:
        result = ''.join(sorted(x.symbol.upper() for x in records))
        if tag != 'shift':
  ...
  def removeAtomSite(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSites, self.removeAtomSite,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeAtomSiteWeight(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSiteWeights, self.removeAtomSiteWeight,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setAtomSiteWeights(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSiteWeights, self.setAtomSiteWeights,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setAtomSites(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomSites, self.setAtomSites,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setExpSteps(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpSteps, self.setExpSteps,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setRefExpDimRefs(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRefExpDimRefs, self.setRefExpDimRefs,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  nucleusCode = property(getNucleusCode, None, None,
  r"""Measurement nucleus (for type shift) or measurement code (e.g. 'delay', 
  MQcc, Jhc, RDChn, ...) for other types
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.ExpMeasurement', ExpMeasurement)

###############################################################################
class ExpStep(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
times, e.g. for out-and-back experiments.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stepNumber', 'expGraph', 'expMeasurement', 'parent', 'refExpDimRefs', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.ExpStep', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.ExpStep.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.ExpStep:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    del dataDict['isDeleted']
    expGraph = dataDict.get('expGraph')
    if (not (expGraph in objsToBeUnDeleted)):

      childrenDict = expGraph.__dict__.get('expSteps')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    expMeasurement = dataDict.get('expMeasurement')
    if ((expMeasurement is not None and not (expMeasurement in objsToBeUnDeleted))):
      expSteps = expMeasurement.__dict__.get('expSteps')
      expSteps.add(self)

    for refExpDimRef in dataDict.get('refExpDimRefs'):
      if (not (refExpDimRef in objsToBeUnDeleted)):
        expSteps = refExpDimRef.__dict__.get('expSteps')
        expSteps.add(self)
  ...
  def addRefExpDimRef(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRefExpDimRefs, self.addRefExpDimRef,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeRefExpDimRef(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRefExpDimRefs, self.removeRefExpDimRef,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setExpMeasurement(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpMeasurement, self.setExpMeasurement,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setStepNumber(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStepNumber, self.setStepNumber,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.ExpStep', ExpStep)

###############################################################################
class ExpTransfer(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
observable peaks from a ginve ExpGraph.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpTransfer
  _metaclass = metaPackage.getElement('ExpTransfer')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'transferToSelf', 'transferType', 'atomSites', 'expGraph', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.ExpTransfer', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.ExpTransfer.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.ExpTransfer:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (expGraph in objsToBeUnDeleted)):
      ...
      childrenDict = expGraph.__dict__.get('expTransfers')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def setTransferToSelf(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTransferToSelf, self.setTransferToSelf,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setTransferType(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTransferType, self.setTransferType,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.ExpTransfer', ExpTransfer)

###############################################################################
class NmrExpPrototype(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
...
experiment
  """
  #   from data model element ccp.nmr.NmrExpPrototype.NmrExpPrototype
  _metaclass = metaPackage.getElement('NmrExpPrototype')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'category', 'ccpnInternalData', 'className', 'createdBy', 'details', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'keywords', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'priority', 'qualifiedName', 'serial', 'synonym', 'activeRepositories', 'atomSites', 'expGraphs', 'expMeasurements', 'memopsRoot', 'packageLocator', 'parent', 'refExperiments', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.NmrExpPrototype', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.NmrExpPrototype.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.NmrExpPrototype:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = memopsRoot.__dict__.get('nmrExpPrototypes')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def addKeyword(self, value):
    ...
    if (_lenValue > 1024):
      raise ApiError("""%s.addKeyword:
       ccp.nmr.NmrExpPrototype.ExpKeyword maximum length is 1024 violated by value""" % self.qualifiedName
       + ": %s" % (value,)
      )
  ...
  def findAllRefExperiments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'isReversed', 'name', 'serial', 'synonym', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def setCategory(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCategory, self.setCategory,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setPriority(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPriority, self.setPriority,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setSynonym(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSynonym, self.setSynonym,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.NmrExpPrototype', NmrExpPrototype)

###############################################################################
class RefExpDim(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Dimension of reference exeriment.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.RefExpDim
  _metaclass = metaPackage.getElement('RefExpDim')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCode', 'ccpnInternalData', 'className', 'dim', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'nucleusCode', 'packageName', 'packageShortName', 'qualifiedName', 'parent', 'refExpDimRefs', 'refExperiment', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.RefExpDim', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.RefExpDim.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.RefExpDim:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    del dataDict['isDeleted']
    refExperiment = dataDict.get('refExperiment')
    if (not (refExperiment in objsToBeUnDeleted)):

      childrenDict = refExperiment.__dict__.get('refExpDims')
      objKey = dataDict.get('dim')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['dim'])""" % self.qualifiedName
  ...
  def getNucleusCode(self):
    ...
    """
    dataDict = self.__dict__
    nucleusCodes = set(x.expMeasurement.nucleusCode for x in self.refExpDimRefs)
    if len(nucleusCodes) == 1:
      result = nucleusCodes.pop()
    else:
      result = 'MULTIPLE'
    return result
  ...
  axisCode = property(getAxisCode, None, None,
  r"""axis code for entire dimension - sorted, comma-separated combination of 
  individual RefExpDimRef.axisCode
  """)
  ...
  nucleusCode = property(getNucleusCode, None, None,
  r"""Nucleus code for dimension. Includes nucleus names, 'J' (J coupling), 
  'MQ' (multiple quantum), 'delay', and 'MULTIPLE' (alternative nuclei).
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.RefExpDim', RefExpDim)

###############################################################################
class RefExpDimRef(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
...
correspond to each other. 
  """
  #   from data model element ccp.nmr.NmrExpPrototype.RefExpDimRef
  _metaclass = metaPackage.getElement('RefExpDimRef')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCode', 'ccpnInternalData', 'className', 'constantTime', 'coupledIsotopeCodes', 'fieldNames', 'groupingId', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'validScalingFactors', 'coupledIsotopes', 'expMeasurement', 'expSteps', 'parent', 'refExpDim', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.RefExpDimRef', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.RefExpDimRef.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.RefExpDimRef:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    del dataDict['isDeleted']
    refExpDim = dataDict.get('refExpDim')
    if (not (refExpDim in objsToBeUnDeleted)):

      childrenDict = refExpDim.__dict__.get('refExpDimRefs')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    if ((expMeasurement is not None and not (expMeasurement in objsToBeUnDeleted))):
      refExpDimRefs = expMeasurement.__dict__.get('refExpDimRefs')
      refExpDimRefs.add(self)

    for expStep in dataDict.get('expSteps'):
      if (not (expStep in objsToBeUnDeleted)):
        refExpDimRefs = expStep.__dict__.get('refExpDimRefs')
        refExpDimRefs.add(self)
  ...
  def addCoupledIsotopeCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCoupledIsotopeCodes, self.addCoupledIsotopeCode,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addExpStep(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpSteps, self.addExpStep,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addValidScalingFactor(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidScalingFactors, self.addValidScalingFactor,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllCoupledIsotopes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'abundance', 'ccpnInternalData', 'gyroMagneticRatio', 'halfLife', 'halfLifeError', 'halfLifeType', 'magneticMoment', 'mass', 'massNumber', 'quadrupoleMoment', 'receptivity', 'spin', 'chemElement',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def getAxisCode(self):
    """
    Get for ccp.nmr.NmrExpPrototype.RefExpDimRef.axisCode
    """
    dataDict = self.__dict__
  ...
  def getCoupledIsotopes(self):
    ...
    for ss in self.coupledIsotopeCodes:
      ...
      result.append(ccpncore.api.ccp.molecule.ChemElement.Isotope.getByKey(self.root.currentChemElementStore, (atomSymbol, massNumber)))
    #
  ...
  def removeCoupledIsotopeCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCoupledIsotopeCodes, self.removeCoupledIsotopeCode,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeExpStep(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExpSteps, self.removeExpStep,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeValidScalingFactor(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidScalingFactors, self.removeValidScalingFactor,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setAxisCode(self, value):
    """
    Set for ccp.nmr.NmrExpPrototype.RefExpDimRef.axisCode
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, ccpnmodel.ccpncore.api.memops.Implementation.String.PythonType)):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAxisCode, self.setAxisCode,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setConstantTime(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConstantTime, self.setConstantTime,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCoupledIsotopeCodes(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCoupledIsotopeCodes, self.setCoupledIsotopeCodes,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setGroupingId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setGroupingId, self.setGroupingId,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setValidScalingFactors(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidScalingFactors, self.setValidScalingFactors,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  r"""axisCode - unique identifier within RefExperiment.
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.RefExpDimRef', RefExpDimRef)

###############################################################################
class RefExperiment(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Reference Experiment. Selects experiment dimensions from the steps 
available in the NmrExpPrototype
  """
  #   from data model element ccp.nmr.NmrExpPrototype.RefExperiment
  _metaclass = metaPackage.getElement('RefExperiment')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCodes', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isReversed', 'metaclass', 'name', 'nucleusCodes', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'synonym', 'nmrExpPrototype', 'orderedDimensions', 'parent', 'refExpDims', 'root', 'systematicNames', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.RefExperiment', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.RefExperiment.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.RefExperiment:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = nmrExpPrototype.__dict__.get('refExperiments')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      values = self.getNucleusCodes()
      for value in values:
        if (isinstance(value, ccpnmodel.ccpncore.api.memops.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: nucleusCodes:
           memops.Implementation.Word input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      values = self.getOrderedDimensions()
      for value in values:
        if (not isinstance(value, RefExpDim)):
          raise ApiError("""%s.checkValid: orderedDimensions:
           value is not of class ccp.nmr.NmrExpPrototype.RefExpDim""" % self.qualifiedName
           + ": %s" % (value,)
          )
        ...
        if (not (xx1 is yy1)):
          raise ApiError("""%s.checkValid: orderedDimensions:
           Link orderedDimensions between objects from separate partitions
            - memops.Implementation.TopObject does not match""" % self.qualifiedName
           + ": %s:%s" % (self, value)
          )
  ...
  def findAllOrderedDimensions(self, **conditions):
    """
    FindAll for ccp.nmr.NmrExpPrototype.RefExperiment.orderedDimensions
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
      currentValues = self.getOrderedDimensions()
      result = list(currentValues)
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'dim', 'refExperiment',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.append(v)
  ...
  def findAllSystematicNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'name', 'namingSystem', 'refExperiment',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findFirstOrderedDimension(self, **conditions):
    """
    FindFirst for ccp.nmr.NmrExpPrototype.RefExperiment.orderedDimensions
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
  ...
  def getAxisCodes(self):
    ...
    """
    dataDict = self.__dict__
    result = tuple(x.axisCode for x in self.orderedDimensions)
    return result
  ...
  def getNucleusCodes(self):
    """
    getter for derived attribtue nucleusCodes
    """
    dataDict = self.__dict__
    result = tuple(x.nucleusCode for x in self.orderedDimensions)
    return result
  
  def getOrderedDimensions(self):
    """
    getter for derived linkorderedDimensions
    """
    dataDict = self.__dict__
    result = self.sortedRefExpDims()
    
    import operator
    
    # Get ExpMeasurements in traversal order
    steps = self.nmrExpPrototype.sortedExpGraphs()[0].sortedExpSteps()
    steps.sort(key=operator.attrgetter('stepNumber'))
    stepMeasurements = [x.expMeasurement for x in steps]
    
    if not self.isReversed:
      # start with last in traverse, unless experiment is reversed
      stepMeasurements.reverse()
    
    for measurement in stepMeasurements:
      for expDim in result:
        if expDim.findFirstRefExpDimRef(expMeasurement=measurement) is not None:
          # DImension matches acquisition measurement. This is it
          acqDimension = expDim
          break
      else:
        continue
      ...
      # Nothing found - should never happen. Take existing order as a default
      acqDimension = result[0]
    
    if acqDimension is not result[0]:
      # Heuristic - given that most dimensions are given in traversal order for non-reversed
      if not self.isReversed:
        result.reverse()
      result = [acqDimension] + [x for x in result if x is not acqDimension]
    return result
  ...
  def setIsReversed(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIsReversed, self.setIsReversed,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  r"""axisCodes in order of orderedDimension (acquisition first)
  """)
  ...
  nucleusCodes = property(getNucleusCodes, None, None,
  r"""nucleus codes for dimensions in dimension order (acquisition 
  first).
  Nucleus codes include nucleus names, 'J' (J coupling), 'MQ' 
  (multiple quantum), 'delay', and 'MULTIPLE' (multiple different nuclei, 
  e.g. for projection experiments or C/N alternative axes').
  """)
  ...
  orderedDimensions = property(getOrderedDimensions, None, None,
  r"""RefExpDims with the acquisition dimension as the first RefExpDim. The 
  other dimensions are roughly in reverse order of traversal.
  """)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.RefExperiment', RefExperiment)

###############################################################################
class SystematicName(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Systematic name for RefExperiment
  """
  #   from data model element ccp.nmr.NmrExpPrototype.SystematicName
  _metaclass = metaPackage.getElement('SystematicName')
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'parent', 'refExperiment', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.nmr.NmrExpPrototype.SystematicName', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.nmr.NmrExpPrototype.SystematicName.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.nmr.NmrExpPrototype.SystematicName:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (refExperiment in objsToBeUnDeleted)):
      ...
      childrenDict = refExperiment.__dict__.get('systematicNames')
      objKey = dataDict.get('namingSystem')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['namingSystem'])""" % self.qualifiedName
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.nmr.NmrExpPrototype.SystematicName', SystematicName)
