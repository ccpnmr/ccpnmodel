...
to a given nucleus is used for filtering during an experiment.
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopeCode', 'maxNumber', 'maxShift', 'metaclass', 'minNumber', 'minShift', 'name', 'numberStep', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'expGraphs', 'expMeasurements', 'expTransfers', 'isotope', 'nmrExpPrototype', 'parent', 'root', 'topObject',)
  ...
  def findAllExpGraphs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'peakSign', 'serial', 'nmrExpPrototype',))
  ...
  def findAllExpMeasurements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'measurementType', 'serial', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllExpTransfers(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'serial', 'transferToSelf', 'transferType', 'expGraph',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
molecule topologies giving rise to peaks of different sign.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'peakSign', 'qualifiedName', 'serial', 'atomSites', 'expMeasurements', 'expSteps', 'expTransfers', 'nmrExpPrototype', 'parent', 'root', 'topObject',)
  ...
  def findAllAtomSites(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'isotopeCode', 'maxNumber', 'maxShift', 'minNumber', 'minShift', 'name', 'numberStep', 'serial', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllExpSteps(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'serial', 'stepNumber', 'expGraph', 'expMeasurement',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
others are possible.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'atomSiteWeights', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'measurementType', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'atomSites', 'expGraphs', 'expSteps', 'nmrExpPrototype', 'parent', 'refExpDimRefs', 'root', 'topObject',)
  ...
  def findAllRefExpDimRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'axisCode', 'constantTime', 'groupingId', 'serial', 'expMeasurement', 'refExpDim',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
times, e.g. for out-and-back experiments.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stepNumber', 'expGraph', 'expMeasurement', 'parent', 'refExpDimRefs', 'root', 'topObject',)
...
observable peaks from a ginve ExpGraph.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'transferToSelf', 'transferType', 'atomSites', 'expGraph', 'parent', 'root', 'topObject',)
...
experiment
  ...
  def findAllRefExperiments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'isReversed', 'name', 'serial', 'synonym', 'nmrExpPrototype',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class RefExpDim(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCode', 'className', 'dim', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'nucleusCode', 'packageName', 'packageShortName', 'qualifiedName', 'parent', 'refExpDimRefs', 'refExperiment', 'root', 'topObject',)
...
correspond to each other. 
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCode', 'className', 'constantTime', 'coupledIsotopeCodes', 'fieldNames', 'groupingId', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'validScalingFactors', 'coupledIsotopes', 'expMeasurement', 'expSteps', 'parent', 'refExpDim', 'root', 'topObject',)
  ...
  def findAllCoupledIsotopes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'abundance', 'gyroMagneticRatio', 'halfLife', 'halfLifeError', 'halfLifeType', 'magneticMoment', 'mass', 'massNumber', 'quadrupoleMoment', 'receptivity', 'spin', 'chemElement',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
available in the NmrExpPrototype
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'axisCodes', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isReversed', 'metaclass', 'name', 'nucleusCodes', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'synonym', 'nmrExpPrototype', 'orderedDimensions', 'parent', 'refExpDims', 'root', 'systematicNames', 'topObject',)
  ...
  def findAllOrderedDimensions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'dim', 'refExperiment',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.append(v)
  ...
  def findAllSystematicNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'namingSystem', 'refExperiment',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class SystematicName(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'parent', 'refExperiment', 'root', 'topObject',)
