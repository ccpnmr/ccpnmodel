...
Autogenerated by PyFileApiGen on Tue Aug 16 03:55:45 2016
...
others are possible.
  ...
  _packageName = 'ccp.nmr.NmrExpPrototype'
  _packageShortName = 'NMRX'
  _fieldNames = ('_ID', 'applicationData', 'atomSiteWeights', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'measurementType', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'atomSites', 'expGraphs', 'expSteps', 'nmrExpPrototype', 'parent', 'refExpDimRefs', 'root', 'topObject',)
