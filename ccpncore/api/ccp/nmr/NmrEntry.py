...
Autogenerated by PyFileApiGen on Sun May 15 02:19:16 2016
...
other depositions?).
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.nmr.NmrEntry.Entry.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllRelatedEntries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'dbCode', 'dbName', 'details', 'relationship', 'entry',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllStructureGroups(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'serial', 'molSystem',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class EntryMolecule(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.nmr.NmrEntry'
  _packageShortName = 'ENTR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'productionMethod', 'qualifiedName', 'sourceType', 'vectorType', 'entry', 'experimentalSource', 'molecule', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.nmr.NmrEntry.EntryMolecule.__init__")
        del dataDict['inConstructor']
        raise
...
class NmrEntryStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  _packageName = 'ccp.nmr.NmrEntry'
  _packageShortName = 'ENTR'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'entries', 'memopsRoot', 'packageLocator', 'parent', 'root', 'studies', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.nmr.NmrEntry.NmrEntryStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllStudies(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'studyType', 'nmrEntryStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class RelatedEntry(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.nmr.NmrEntry'
  _packageShortName = 'ENTR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'dbCode', 'dbName', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'relationship', 'entry', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.nmr.NmrEntry.RelatedEntry.__init__")
        del dataDict['inConstructor']
        raise
...
class Study(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.nmr.NmrEntry'
  _packageShortName = 'ENTR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'keywords', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'studyType', 'entries', 'nmrEntryStore', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.nmr.NmrEntry.Study.__init__")
        del dataDict['inConstructor']
        raise
