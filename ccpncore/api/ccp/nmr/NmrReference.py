...
i+1-refPoint).
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'data', 'defaultValue', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'ndim', 'packageName', 'packageShortName', 'qualifiedName', 'refPoints', 'refValues', 'serial', 'shape', 'size', 'valuesPerPoint', 'chemCompNmrRef', 'parent', 'refAtoms', 'root', 'topObject',)
  ...
  def findAllRefAtoms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'meanValue', 'name', 'randomCoilValue', 'refPoint', 'refValue', 'serial', 'stdDev', 'subType', 'valuePerPoint', 'chemCompNmrRef',))
...
the meanValue or the randomCoilValue attribute must be set.
  ...
  def findAllChemAtomShiftCorrs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpCode', 'molType', 'seqOffset', 'value', 'chemAtomNmrRef',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllChemAtoms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'subType', 'chemComp',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllChemCompVarNmrRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'descriptor', 'linking', 'chemCompNmrRef',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllShiftDistributions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'defaultValue', 'serial', 'chemCompNmrRef',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
in Xxx.
  ...
  _packageName = 'ccp.nmr.NmrReference'
  _packageShortName = 'NMRR'
  _fieldNames = ('_ID', 'applicationData', 'ccpCode', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'seqOffset', 'value', 'chemAtomNmrRef', 'chemComp', 'parent', 'root', 'topObject',)
...
source. 
  ...
  _packageName = 'ccp.nmr.NmrReference'
  _packageShortName = 'NMRR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'sourceName', 'chemAtomNmrDistribs', 'chemAtomNmrRefs', 'chemCompVarNmrRefs', 'nmrReferenceStore', 'parent', 'root', 'topObject',)
...
relevant Vars
  ...
  _packageName = 'ccp.nmr.NmrReference'
  _packageShortName = 'NMRR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'descriptor', 'fieldNames', 'inConstructor', 'isDeleted', 'linking', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'chemAtomNmrRefs', 'chemCompNmrRef', 'chemCompVars', 'parent', 'root', 'topObject',)
...
handle, holding information about where the actual data are stored.
  ...
  def findAllChemCompNmrRefs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'sourceName', 'nmrReferenceStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
