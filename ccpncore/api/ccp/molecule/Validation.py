...
Autogenerated by PyFileApiGen on Sun May 15 02:19:12 2016
...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.molecule.Validation')

###############################################################################
class ValidationResult(ccpnmodel.ccpncore.api.ccp.general.Template.MultiTypeValue):
  r"""
  """
  #   from data model element ccp.molecule.Validation.ValidationResult
  _metaclass = metaPackage.getElement('ValidationResult')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'parent', 'root', 'topObject', 'validationStore',)
  ...
  def getKeywordDefinition(self):
    ...
    """
    dataDict = self.__dict__
    cc = ccpnmodel.ccpncore.api.ccp.general.KeywordDefinition.KeywordDefinition
  ...
  def setFigOfMerit(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setFigOfMerit, self.setFigOfMerit,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
_addModuleFunctionsToApiClass('ccp.molecule.Validation.ValidationResult', ValidationResult)

###############################################################################
class ValidationStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""TopObject for Validation package
  """
  #   from data model element ccp.molecule.Validation.ValidationStore
  _metaclass = metaPackage.getElement('ValidationStore')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'memopsRoot', 'nmrCalcStores', 'nmrConstraintStore', 'nmrProject', 'packageLocator', 'parent', 'root', 'software', 'structureEnsemble', 'topObject', 'validationResults',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.molecule.Validation.ValidationStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.ValidationStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.ValidationStore:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    childrenDict = memopsRoot.__dict__.get('validationStores')
    objKey = dataDict.get('name')
    if (objKey is None):
    ...
    software = dataDict.get('software')
    if ((software is not None and not (software in objsToBeUnDeleted))):
      validationStores = software.__dict__.get('validationStores')
      validationStores.add(self)

    structureEnsemble = dataDict.get('structureEnsemble')
    if ((structureEnsemble is not None and not (structureEnsemble in objsToBeUnDeleted))):
      validationStores = structureEnsemble.__dict__.get('validationStores')
      validationStores.add(self)
  ...
  def findAllValidationResults(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'booleanValue', 'context', 'details', 'figOfMerit', 'floatValue', 'intValue', 'keyword', 'serial', 'textValue', 'validationStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.ValidationStore', ValidationStore)

###############################################################################
class PeakListValidation(ValidationResult):
  r"""Validation result for one or more PeakLists
  """
  #   from data model element ccp.molecule.Validation.PeakListValidation
  _metaclass = metaPackage.getElement('PeakListValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'parent', 'peakLists', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.PeakListValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.PeakListValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.PeakListValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    ...
    childrenDict = validationStore.__dict__.get('validationResults')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      from ccpnmodel.ccpncore.api.ccp.general.KeywordDefinition import KeywordDefinition as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.checkValid: keywordDefinition:
  ...
  def findAllPeakLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'dataType', 'details', 'isSimulated', 'name', 'serial', 'symbolColour', 'symbolStyle', 'textColour', 'dataSource', 'fitMethod', 'intensMethod', 'nmrConstraintStore', 'specificShiftList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.PeakListValidation', PeakListValidation)

###############################################################################
class PeakValidation(ValidationResult):
  r"""
  """
  #   from data model element ccp.molecule.Validation.PeakValidation
  _metaclass = metaPackage.getElement('PeakValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'parent', 'peaks', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.PeakValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.PeakValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.PeakValidation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for peak in dataDict.get('peaks'):
      if (not (peak in objsToBeUnDeleted)):
        peakValidations = peak.__dict__.get('peakValidations')
        peakValidations.add(self)
  ...
  def findAllPeaks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'annotation', 'constraintWeight', 'details', 'figOfMerit', 'height', 'heightError', 'offset', 'serial', 'volume', 'volumeError', 'fitMethod', 'peakList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.PeakValidation', PeakValidation)

###############################################################################
class MolSysResidueValidation(ValidationResult):
  r"""Validation result for MolSystem Residue
  """
  #   from data model element ccp.molecule.Validation.MolSysResidueValidation
  _metaclass = metaPackage.getElement('MolSysResidueValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'parent', 'residues', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.MolSysResidueValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.MolSysResidueValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.MolSysResidueValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for residue in dataDict.get('residues'):
      if (not (residue in objsToBeUnDeleted)):
        molSysResidueValidations = residue.__dict__.get('molSysResidueValidations')
        molSysResidueValidations.add(self)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.MolSysResidueValidation', MolSysResidueValidation)
...
class NmrConstraintListValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.NmrConstraintListValidation
  _metaclass = metaPackage.getElement('NmrConstraintListValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'nmrConstraintLists', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.NmrConstraintListValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.NmrConstraintListValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.NmrConstraintListValidation:
     undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for nmrConstraintList in dataDict.get('nmrConstraintLists'):
      if (not (nmrConstraintList in objsToBeUnDeleted)):
        nmrConstraintListValidations = nmrConstraintList.__dict__.get('nmrConstraintListValidations')
        nmrConstraintListValidations.add(self)
  ...
  def addNmrConstraintList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraintLists, self.addNmrConstraintList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeNmrConstraintList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraintLists, self.removeNmrConstraintList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setNmrConstraintLists(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraintLists, self.setNmrConstraintLists,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.NmrConstraintListValidation', NmrConstraintListValidation)

###############################################################################
class MolSysAtomValidation(ValidationResult):
  r"""Validation result for MolSystem Atom
  """
  #   from data model element ccp.molecule.Validation.MolSysAtomValidation
  _metaclass = metaPackage.getElement('MolSysAtomValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'atoms', 'keywordDefinition', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.MolSysAtomValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.MolSysAtomValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.MolSysAtomValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for atom in dataDict.get('atoms'):
      if (not (atom in objsToBeUnDeleted)):
        molSysAtomValidations = atom.__dict__.get('molSysAtomValidations')
        molSysAtomValidations.add(self)
  ...
  def findAllAtoms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'atomSetName', 'atomType', 'elementSymbol', 'name', 'atomSet', 'residue',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.MolSysAtomValidation', MolSysAtomValidation)

###############################################################################
class EntryValidation(ValidationResult):
  r"""Validation results for the entire validation entry
  """
  #   from data model element ccp.molecule.Validation.EntryValidation
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.EntryValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.EntryValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.EntryValidation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.EntryValidation', EntryValidation)

###############################################################################
class AtomValidation(ValidationResult):
  r"""Validation result for one or more Atoms
  """
  #   from data model element ccp.molecule.Validation.AtomValidation
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.AtomValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.AtomValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.AtomValidation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
  ...
  def addAtom(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.molecule.MolStructure import Atom as importedType
    if (not isinstance(value, importedType)):
      raise ApiError("""%s.addAtom:
  ...
  def findAllAtoms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'altLocationCode', 'elementName', 'index', 'name', 'residue',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.AtomValidation', AtomValidation)

###############################################################################
class EnsembleValidation(ValidationResult):
  r"""Validation result for the total structure ensemble
  """
  #   from data model element ccp.molecule.Validation.EnsembleValidation
  _metaclass = metaPackage.getElement('EnsembleValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'parent', 'root', 'structureEnsemble', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.EnsembleValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.EnsembleValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.EnsembleValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.EnsembleValidation', EnsembleValidation)

###############################################################################
class MolSysChainValidation(ValidationResult):
  r"""Validation result for MolSystem.Chain
  """
  #   from data model element ccp.molecule.Validation.MolSysChainValidation
  _metaclass = metaPackage.getElement('MolSysChainValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'chains', 'keywordDefinition', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.MolSysChainValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.MolSysChainValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.MolSysChainValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for chain in dataDict.get('chains'):
      if (not (chain in objsToBeUnDeleted)):
        molSysChainValidations = chain.__dict__.get('molSysChainValidations')
        molSysChainValidations.add(self)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.MolSysChainValidation', MolSysChainValidation)

###############################################################################
class MolSystemValidation(ValidationResult):
  r"""Validation result for an entire molecular system
  """
  #   from data model element ccp.molecule.Validation.MolSystemValidation
  _metaclass = metaPackage.getElement('MolSystemValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'molSystems', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.MolSystemValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.MolSystemValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.MolSystemValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.MolSystemValidation', MolSystemValidation)

###############################################################################
class NmrMeasurementListValidation(ValidationResult):
  r"""Validation result for one or more Nmr.MeasuermentLists
  """
  #   from data model element ccp.molecule.Validation.NmrMeasurementListValidation
  _metaclass = metaPackage.getElement('NmrMeasurementListValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'nmrMeasurementLists', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.NmrMeasurementListValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.NmrMeasurementListValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.NmrMeasurementListValidation:
      undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for nmrMeasurementList in dataDict.get('nmrMeasurementLists'):
      if (not (nmrMeasurementList in objsToBeUnDeleted)):
        nmrMeasurementListValidations = nmrMeasurementList.__dict__.get('nmrMeasurementListValidations')
        nmrMeasurementListValidations.add(self)
  ...
  def addNmrMeasurementList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurementLists, self.addNmrMeasurementList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllNmrMeasurementLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'isSimulated', 'name', 'serial', 'unit', 'method', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeNmrMeasurementList(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurementLists, self.removeNmrMeasurementList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setNmrMeasurementLists(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurementLists, self.setNmrMeasurementLists,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.NmrMeasurementListValidation', NmrMeasurementListValidation)

###############################################################################
class NmrConstraintValidation(ValidationResult):
  r"""Validation result for one or more NmrConstraint.AbstractConstraints
  """
  #   from data model element ccp.molecule.Validation.NmrConstraintValidation
  _metaclass = metaPackage.getElement('NmrConstraintValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'nmrConstraints', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.NmrConstraintValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.NmrConstraintValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.NmrConstraintValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for nmrConstraint in dataDict.get('nmrConstraints'):
      if (not (nmrConstraint in objsToBeUnDeleted)):
        nmrConstraintValidations = nmrConstraint.__dict__.get('nmrConstraintValidations')
        nmrConstraintValidations.add(self)
  ...
  def addNmrConstraint(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.nmr.NmrConstraint import AbstractConstraint as importedType
    if (not isinstance(value, importedType)):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraints, self.addNmrConstraint,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllNmrConstraints(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'origData', 'serial', 'weight', 'method', 'parentList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeNmrConstraint(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraints, self.removeNmrConstraint,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setNmrConstraints(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrConstraints, self.setNmrConstraints,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.NmrConstraintValidation', NmrConstraintValidation)

###############################################################################
class NmrMeasurementValidation(ValidationResult):
  r"""Validation result for one or more Nmr.Mesurements
  """
  #   from data model element ccp.molecule.Validation.NmrMeasurementValidation
  _metaclass = metaPackage.getElement('NmrMeasurementValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'nmrMeasurements', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.NmrMeasurementValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.NmrMeasurementValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.NmrMeasurementValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    for nmrMeasurement in dataDict.get('nmrMeasurements'):
      if (not (nmrMeasurement in objsToBeUnDeleted)):
        nmrMeasurementValidations = nmrMeasurement.__dict__.get('nmrMeasurementValidations')
        nmrMeasurementValidations.add(self)
  ...
  def addNmrMeasurement(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import AbstractMeasurement as importedType
    if (not isinstance(value, importedType)):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurements, self.addNmrMeasurement,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def findAllNmrMeasurements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'error', 'figOfMerit', 'value', 'method', 'parentList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeNmrMeasurement(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurements, self.removeNmrMeasurement,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setNmrMeasurements(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrMeasurements, self.setNmrMeasurements,
                      undoArgs=(currentValues,), redoArgs=(values,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.NmrMeasurementValidation', NmrMeasurementValidation)

###############################################################################
class StructureValidation(ValidationResult):
  r"""Validation result for one or more MolStructures
  """
  #   from data model element ccp.molecule.Validation.StructureValidation
  _metaclass = metaPackage.getElement('StructureValidation')
  _packageName = 'ccp.molecule.Validation'
  _packageShortName = 'VALD'
  _fieldNames = ('_ID', 'applicationData', 'booleanValue', 'className', 'context', 'details', 'fieldNames', 'figOfMerit', 'floatValue', 'inConstructor', 'intValue', 'isDeleted', 'keyword', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'textValue', 'keywordDefinition', 'models', 'parent', 'root', 'topObject', 'validationStore',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.StructureValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.StructureValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.StructureValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.StructureValidation', StructureValidation)

###############################################################################
class ResidueValidation(ValidationResult):
  r"""Validation result for one or more Residues
  """
  #   from data model element ccp.molecule.Validation.ResidueValidation
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.ResidueValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.ResidueValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.ResidueValidation:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
  ...
  def addResidue(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.molecule.MolStructure import Residue as importedType
    if (not isinstance(value, importedType)):
      raise ApiError("""%s.addResidue:
  ...
  def findAllResidues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code3Letter', 'seqCode', 'seqId', 'seqInsertCode', 'chain',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.ResidueValidation', ResidueValidation)

###############################################################################
class ChainValidation(ValidationResult):
  r"""Validation result for one or more Chains
  """
  #   from data model element ccp.molecule.Validation.ChainValidation
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Validation.ChainValidation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.molecule.Validation.ChainValidation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Validation.ChainValidation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
  ...
  def addChain(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.molecule.MolStructure import Chain as importedType
    if (not isinstance(value, importedType)):
      raise ApiError("""%s.addChain:
  ...
  def findAllChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Validation.ChainValidation', ChainValidation)
