...
Autogenerated by PyFileApiGen on Mon May 16 03:10:54 2016
...
cleared first.
  ...
  _fieldNames = ('_ID', 'applicationData', 'atomSetName', 'atomType', 'className', 'elementSymbol', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'atomGroups', 'atomSet', 'boundAtoms', 'chemAtom', 'chemAtomSet', 'components', 'fixedAtomSets', 'genericBonds', 'molSysAtomValidations', 'parent', 'residue', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.Atom.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllFixedAtomSets(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'serial', 'nmrConstraintStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllGenericBonds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'bondType', 'molSystem',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
creates the Residue and Atom objects corresponding to it. 
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.Chain.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllChainFragments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'isLinearPolymer', 'molType', 'serial', 'chain',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllChainInteractions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'interactionType', 'molSystem',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDangleChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'chain', 'dangleStore', 'nmrConstraintStore', 'shiftList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
normal way of dividing a Chain in ChainFragments.
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isLinearPolymer', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'chain', 'parent', 'residues', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.ChainFragment.__init__")
        del dataDict['inConstructor']
        raise
...
class ChainInteraction(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'interactionType', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'chains', 'molSystem', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.ChainInteraction.__init__")
        del dataDict['inConstructor']
        raise
...
bond')
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'bondType', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'atoms', 'molSystem', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.GenericBond.__init__")
        del dataDict['inConstructor']
        raise
...
NMR-observable impurities in an Nmr study). 
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.MolSystem.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllDbReferences(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'altCode', 'code', 'details', 'name', 'release', 'serial', 'subCode', 'url', 'database',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMolSystemLinks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'dihedralAngle', 'molSystem',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMolSystemSysNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'namingSystem', 'molSystem',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
links.
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'dihedralAngle', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'molSystem', 'molSystemLinkEnds', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.MolSystemLink.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllMolSystemLinkEnds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'linkCode', 'molSystemLink', 'residue',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
of the MolSystem
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'linkCode', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'linkEnd', 'molSystemLink', 'parent', 'residue', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.MolSystemLinkEnd.__init__")
        del dataDict['inConstructor']
        raise
...
class MolSystemSysName(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'molSystem', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.MolSystemSysName.__init__")
        del dataDict['inConstructor']
        raise
...
(Chain)). 
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'ccpCode', 'className', 'code3Letter', 'descriptor', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'linking', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'seqCode', 'seqId', 'seqInsertCode', 'atoms', 'chain', 'chainFragment', 'chemCompVar', 'dangleResidues', 'molResidue', 'molSysResidueValidations', 'molSystemLinkEnds', 'parent', 'residueProbs', 'resonanceGroups', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.Residue.__init__")
        del dataDict['inConstructor']
        raise
      ...
      try:
        ...
        for chemAtom in ccv.chemAtoms:
          if isinstance(chemAtom, clazz):
            atom = Atom(self, name=chemAtom.name)
            if _undo.blocking <= 1:
  ...
  def findAllDangleResidues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'numIslands', 'omegaLower', 'omegaUpper', 'omegaValue', 'phiLower', 'phiUpper', 'phiValue', 'psiLower', 'psiUpper', 'psiValue', 'secStrucCode', 'dangleChain', 'residue',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllResidueProbs(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'weight', 'possibility', 'resonanceGroup',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
structures. May be from same or different generation cycles.
  ...
  _packageName = 'ccp.molecule.MolSystem'
  _packageShortName = 'MOLS'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'entries', 'models', 'molSystem', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.MolSystem.StructureGroup.__init__")
        del dataDict['inConstructor']
        raise
