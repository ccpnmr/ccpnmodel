...
class ChemElement(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'atomNumber', 'atomicRadius', 'className', 'covalentRadius', 'fieldNames', 'inConstructor', 'isDeleted', 'mass', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'symbol', 'chemElementStore', 'isotopes', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemElement.ChemElement.__init__")
        del dataDict['inConstructor']
        raise
...
class ChemElementStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  _packageName = 'ccp.molecule.ChemElement'
  _packageShortName = 'CHEL'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'chemElements', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemElement.ChemElementStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllChemElements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'atomNumber', 'atomicRadius', 'covalentRadius', 'mass', 'name', 'symbol', 'chemElementStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class Isotope(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.ChemElement'
  _packageShortName = 'CHEL'
  _fieldNames = ('_ID', 'abundance', 'applicationData', 'className', 'fieldNames', 'gyroMagneticRatio', 'halfLife', 'halfLifeError', 'halfLifeType', 'inConstructor', 'isDeleted', 'magneticMoment', 'mass', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'quadrupoleMoment', 'qualifiedName', 'receptivity', 'spin', 'chemElement', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemElement.Isotope.__init__")
        del dataDict['inConstructor']
        raise
