...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.molecule.ChemElement')

###############################################################################
class ChemElement(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""e.g. C
  """
  #   from data model element ccp.molecule.ChemElement.ChemElement
  _metaclass = metaPackage.getElement('ChemElement')
  _packageName = 'ccp.molecule.ChemElement'
  _packageShortName = 'CHEL'
  _fieldNames = ('_ID', 'applicationData', 'atomNumber', 'atomicRadius', 'ccpnInternalData', 'className', 'covalentRadius', 'fieldNames', 'inConstructor', 'isDeleted', 'mass', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'symbol', 'chemElementStore', 'isotopes', 'parent', 'root', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.molecule.ChemElement.ChemElement', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.ChemElement.ChemElement.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.ChemElement.ChemElement:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    childrenDict = chemElementStore.__dict__.get('chemElements')
    objKey = dataDict.get('symbol')
    if (objKey is None):
  ...
  def setAtomNumber(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomNumber, self.setAtomNumber,
  ...
  def setAtomicRadius(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAtomicRadius, self.setAtomicRadius,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCovalentRadius(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCovalentRadius, self.setCovalentRadius,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMass(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMass, self.setMass,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
_addModuleFunctionsToApiClass('ccp.molecule.ChemElement.ChemElement', ChemElement)

###############################################################################
class ChemElementStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""Grouping of ChemElement information
  """
  #   from data model element ccp.molecule.ChemElement.ChemElementStore
  _metaclass = metaPackage.getElement('ChemElementStore')
  _packageName = 'ccp.molecule.ChemElement'
  _packageShortName = 'CHEL'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'chemElements', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.ChemElement.ChemElementStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.ChemElement.ChemElementStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.ChemElement.ChemElementStore:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    ...
    childrenDict = memopsRoot.__dict__.get('chemElementStores')
    objKey = dataDict.get('name')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['name'])""" % self.qualifiedName
  ...
  def findAllChemElements(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'atomNumber', 'atomicRadius', 'ccpnInternalData', 'covalentRadius', 'mass', 'name', 'symbol', 'chemElementStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.ChemElement.ChemElementStore', ChemElementStore)

###############################################################################
class Isotope(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Nuclear Isotope
  """
  #   from data model element ccp.molecule.ChemElement.Isotope
  _metaclass = metaPackage.getElement('Isotope')
  _packageName = 'ccp.molecule.ChemElement'
  _packageShortName = 'CHEL'
  _fieldNames = ('_ID', 'abundance', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'gyroMagneticRatio', 'halfLife', 'halfLifeError', 'halfLifeType', 'inConstructor', 'isDeleted', 'magneticMoment', 'mass', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'quadrupoleMoment', 'qualifiedName', 'receptivity', 'spin', 'chemElement', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.ChemElement.Isotope', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.ChemElement.Isotope.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.ChemElement.Isotope:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    del dataDict['isDeleted']
    chemElement = dataDict.get('chemElement')
    if (not (chemElement in objsToBeUnDeleted)):

      childrenDict = chemElement.__dict__.get('isotopes')
      objKey = dataDict.get('massNumber')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['massNumber'])""" % self.qualifiedName
  ...
  def setAbundance(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAbundance, self.setAbundance,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setGyroMagneticRatio(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setGyroMagneticRatio, self.setGyroMagneticRatio,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setHalfLife(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setHalfLife, self.setHalfLife,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setHalfLifeError(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setHalfLifeError, self.setHalfLifeError,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setHalfLifeType(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setHalfLifeType, self.setHalfLifeType,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMagneticMoment(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMagneticMoment, self.setMagneticMoment,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setQuadrupoleMoment(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setQuadrupoleMoment, self.setQuadrupoleMoment,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setReceptivity(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setReceptivity, self.setReceptivity,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setSpin(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSpin, self.setSpin,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.ChemElement.Isotope', Isotope)
