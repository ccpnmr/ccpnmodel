  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.Symmetry.MolSystemSymmetrySet.__init__")
        del dataDict['inConstructor']
        raise
...
class Segment(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.Symmetry'
  _packageShortName = 'SYMM'
  _fieldNames = ('_ID', 'applicationData', 'chainCode', 'className', 'fieldNames', 'firstSeqId', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'parent', 'residues', 'root', 'symmetry', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.Symmetry.Segment.__init__")
        del dataDict['inConstructor']
        raise
...
a multichain MolSystem.
  ...
  _packageName = 'ccp.molecule.Symmetry'
  _packageShortName = 'SYMM'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'segmentLength', 'serial', 'symmetryCode', 'haddockRuns', 'molSystemSymmetrySet', 'parent', 'root', 'segments', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.Symmetry.Symmetry.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllSegments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'chainCode', 'firstSeqId', 'symmetry',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
