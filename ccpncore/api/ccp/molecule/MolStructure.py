...
Corresponds to a PDB MODEL.
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'bFactors', 'className', 'coordinates', 'details', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'specificAtomNames', 'parent', 'root', 'structureEnsemble', 'structureGroups', 'structureValidations', 'topObject', 'violationLists',)
...
replacing DataMatrices
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'value', 'parent', 'root', 'structureEnsemble', 'topObject',)
...
trajectory for the MolSystem or part of it.
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'atomNamingSystem', 'className', 'createdBy', 'data', 'dataPath', 'details', 'ensembleId', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'nAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'resNamingSystem', 'softwareName', 'activeRepositories', 'coordChains', 'dataMatrices', 'ensembleValidations', 'memopsRoot', 'models', 'molSystem', 'nmrConstraintStore', 'orderedAtoms', 'packageLocator', 'parameters', 'parent', 'primaryNmrConstraintStore', 'root', 'structureAnalyses', 'structureGeneration', 'topObject', 'validationStores',)
  ...
  def findAllParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'value', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
