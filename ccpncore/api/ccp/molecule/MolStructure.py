...
a given set of coordinates.
  ...
  _fieldNames = ('_ID', 'altLocationCode', 'applicationData', 'bFactors', 'className', 'coordinates', 'elementName', 'elementSymbol', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'iupacNames', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'atom', 'atomValidations', 'chemAtom', 'parent', 'residue', 'root', 'topObject',)
  ...
  def getElementSymbol(self):
    ...
    if result == 'Unknown':
      ...
      if residue is not None:
        atom = residue.residue.chemCompVar.findFirstChemAtom(name=self.name)
  ...
  Deprecated - used for V" compatibility only.
  """)
...
class Chain(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'chain', 'chainValidations', 'parent', 'residues', 'root', 'structureEnsemble', 'topObject',)
...
created
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'data', 'defaultValue', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'ndim', 'packageName', 'packageShortName', 'qualifiedName', 'shape', 'size', 'unit', 'parent', 'root', 'structureEnsemble', 'topObject',)
...
Corresponds to a PDB MODEL.
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'bFactors', 'className', 'coordinates', 'details', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'parent', 'root', 'structureEnsemble', 'structureGroups', 'structureValidations', 'topObject', 'violationLists',)
  ...
  def findAllViolationLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'serial', 'nmrConstraintStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class Residue(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code3Letter', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'seqCode', 'seqId', 'seqInsertCode', 'atoms', 'chain', 'parent', 'residue', 'residueValidations', 'root', 'topObject',)
...
trajectory for the MolSystem or part of it.
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'atomNamingSystem', 'className', 'createdBy', 'data', 'dataPath', 'details', 'ensembleId', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'nAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'resNamingSystem', 'softwareName', 'activeRepositories', 'coordChains', 'dataMatrices', 'ensembleValidations', 'memopsRoot', 'models', 'molSystem', 'nmrConstraintStore', 'orderedAtoms', 'packageLocator', 'parent', 'primaryNmrConstraintStore', 'root', 'structureAnalyses', 'structureGeneration', 'topObject', 'validationStores',)
  ...
  def findAllDataMatrices(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'defaultValue', 'details', 'name', 'unit', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
