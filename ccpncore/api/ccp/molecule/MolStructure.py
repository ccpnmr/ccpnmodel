...
a given set of coordinates.
  ...
  _fieldNames = ('_ID', 'altLocationCode', 'applicationData', 'bFactors', 'ccpnInternalData', 'className', 'coordinates', 'elementName', 'elementSymbol', 'fieldNames', 'implSpecificNames', 'inConstructor', 'index', 'isDeleted', 'iupacNames', 'metaclass', 'modelSpecificNames', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'atom', 'atomValidations', 'chemAtom', 'coords', 'parent', 'residue', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.Atom.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllCoords(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'atom', 'model',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def getCoords(self):
    """
    getter for derived link coords
    """
    dataDict = self.__dict__
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.Chain.__init__")
        del dataDict['inConstructor']
        raise
...
###############################################################################
class Coord(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Obsolete coordinate class - but required for backwards compatibility
  """
  #   from data model element ccp.molecule.MolStructure.Coord
  _metaclass = metaPackage.getElement('Coord')
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'altLocationCode', 'applicationData', 'bFactor', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'occupancy', 'packageName', 'packageShortName', 'qualifiedName', 'x', 'y', 'z', 'atom', 'model', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.MolStructure.Coord', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.MolStructure.Coord.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.MolStructure.Coord:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (atom in objsToBeUnDeleted)):
      ...
      childrenDict = atom.__dict__.get('coords')
      objKey = dataDict.get('model')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['model'])""" % self.qualifiedName
    ...
    model = dataDict.get('model')
    if ((model is not None and not (model in objsToBeUnDeleted))):
      coords = model.__dict__.get('coords')
      coords.add(self)
  ...
  def setAltLocationCode(self, value):
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setAltLocationCode')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAltLocationCode, self.setAltLocationCode,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setBFactor(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setBFactor, self.setBFactor,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setOccupancy(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setOccupancy, self.setOccupancy,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.MolStructure.Coord', Coord)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.DataMatrix.__init__")
        del dataDict['inConstructor']
        raise
...
Corresponds to a PDB MODEL.
  ...
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('_ID', 'applicationData', 'bFactors', 'ccpnInternalData', 'className', 'coordinates', 'details', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'specificAtomNames', 'coords', 'parent', 'root', 'structureEnsemble', 'structureGroups', 'structureValidations', 'topObject', 'violationLists',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.Model.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def setCoords(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCoords, self.setCoords,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.Parameter.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.Residue.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.MolStructure.StructureEnsemble.__init__")
        del dataDict['inConstructor']
        raise
