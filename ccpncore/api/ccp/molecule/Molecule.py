...
class Alignment(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'alignLength', 'alignmentProgram', 'alignmentScore', 'applicationData', 'ccpnInternalData', 'className', 'dbRefAlignBegin', 'dbRefAlignEnd', 'details', 'fieldNames', 'homologyRatio', 'inConstructor', 'isDeleted', 'metaclass', 'nIdentical', 'nPositive', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'dbRef', 'molSeqFragment', 'molecule', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.Alignment.__init__")
        del dataDict['inConstructor']
        raise
...
unknown disulfide binding topology). 
  ...
  _packageName = 'ccp.molecule.Molecule'
  _packageShortName = 'MOLE'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'dihedralAngle', 'fieldNames', 'inConstructor', 'isDeleted', 'isStdLinear', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'molResLinkEnds', 'molecule', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.MolResLink.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllMolResLinkEnds(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'linkCode', 'molResLink', 'molResidue',))
...
more chains.
  ...
  _packageName = 'ccp.molecule.Molecule'
  _packageShortName = 'MOLE'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'linkCode', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'linkEnd', 'molResLink', 'molResidue', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.MolResLinkEnd.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def getLinkEnd(self):
    ...
    """
    dataDict = self.__dict__
    result = self.molResidue.chemComp.findFirstLinkEnd(linkCode=self.linkCode)
    return result
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.MolResidue.__init__")
        del dataDict['inConstructor']
        raise
...
are disjoint and no residue can be a member of more than one.
  ...
  _packageName = 'ccp.molecule.Molecule'
  _packageShortName = 'MOLE'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'organismName', 'organismSciName', 'packageName', 'packageShortName', 'qualifiedName', 'alignments', 'limitResidues', 'molecule', 'naturalSource', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.MolSeqFragment.__init__")
        del dataDict['inConstructor']
        raise
...
etc. 
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.Molecule.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllMolResLinks(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'dihedralAngle', 'molecule',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMolSeqFragments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'molecule', 'naturalSource',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMoleculeSysNames(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'name', 'namingSystem', 'molecule',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def getMolType(self):
    ...
    'protein', 'DNA', 'RNA', 'carbohydrate', 'other', or 'DNA/RNA'
    """
    dataDict = self.__dict__
    ...
    if len(aset) == 1:
      result = aset.pop()
      if result not in ('protein', 'DNA', 'RNA', 'carbohydrate', 'other'):
        # This takes care of type 'dummy'
        result = None
...
class MoleculeSysName(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.Molecule'
  _packageShortName = 'MOLE'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'molecule', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.molecule.Molecule.MoleculeSysName.__init__")
        del dataDict['inConstructor']
        raise
