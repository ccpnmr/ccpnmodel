...
class AtomLabel(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopeCode', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'subType', 'weight', 'chemAtom', 'isotope', 'isotopomer', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemCompLabel.AtomLabel.__init__")
        del dataDict['inConstructor']
        raise
...
class ChemCompLabel(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.ChemCompLabel'
  _packageShortName = 'CCLB'
  _fieldNames = ('_ID', 'applicationData', 'ccpCode', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'chemComp', 'isotopomers', 'labelingScheme', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemCompLabel.ChemCompLabel.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllIsotopomers(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'serial', 'weight', 'chemCompLabel',))
...
uncorrelated isotope distribution on its atoms.
  ...
  _packageName = 'ccp.molecule.ChemCompLabel'
  _packageShortName = 'CCLB'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'atomLabels', 'chemCompLabel', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemCompLabel.Isotopomer.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllAtomLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'isotopeCode', 'name', 'subType', 'weight', 'isotopomer',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
same source or are generally used together.
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.ChemCompLabel.LabelingScheme.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllChemCompLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpCode', 'molType', 'labelingScheme',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
