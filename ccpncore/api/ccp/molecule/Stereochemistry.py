...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.molecule.Stereochemistry')

###############################################################################
class RefStereochemistry(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Stereochemistry type (e.g. tetrahedral, allene-like, ...) following 
SMILES conventions. 
  """
  #   from data model element ccp.molecule.Stereochemistry.RefStereochemistry
  _metaclass = metaPackage.getElement('RefStereochemistry')
  _packageName = 'ccp.molecule.Stereochemistry'
  _packageShortName = 'STER'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'numAtoms', 'numCoreAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stereoClass', 'values', 'parent', 'root', 'stereochemistryStore', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.molecule.Stereochemistry.RefStereochemistry', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.Stereochemistry.RefStereochemistry.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Stereochemistry.RefStereochemistry:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    ...
    childrenDict = stereochemistryStore.__dict__.get('refStereochemistries')
    objKey = dataDict.get('serial')
    if (objKey is None):
  ...
  def addValue(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValues, self.addValue,
  ...
  def removeValue(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValues, self.removeValue,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setNumCoreAtoms(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNumCoreAtoms, self.setNumCoreAtoms,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setValues(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValues, self.setValues,
...
_addModuleFunctionsToApiClass('ccp.molecule.Stereochemistry.RefStereochemistry', RefStereochemistry)

###############################################################################
class StereochemistryStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""grouping for stereochemistry reference data
  """
  #   from data model element ccp.molecule.Stereochemistry.StereochemistryStore
  _metaclass = metaPackage.getElement('StereochemistryStore')
  _packageName = 'ccp.molecule.Stereochemistry'
  _packageShortName = 'STER'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'memopsRoot', 'packageLocator', 'parent', 'refStereochemistries', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.molecule.Stereochemistry.StereochemistryStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.molecule.Stereochemistry.StereochemistryStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.molecule.Stereochemistry.StereochemistryStore:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    childrenDict = memopsRoot.__dict__.get('stereochemistryStores')
    objKey = dataDict.get('name')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['name'])""" % self.qualifiedName
  ...
  def findAllRefStereochemistries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'details', 'numAtoms', 'numCoreAtoms', 'serial', 'stereoClass', 'stereochemistryStore',))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.molecule.Stereochemistry.StereochemistryStore', StereochemistryStore)
