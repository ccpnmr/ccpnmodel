...
SMILES conventions. 
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'numAtoms', 'numCoreAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'stereoClass', 'values', 'parent', 'root', 'stereochemistryStore', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.Stereochemistry.RefStereochemistry.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.molecule.Stereochemistry.StereochemistryStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllRefStereochemistries(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'details', 'numAtoms', 'numCoreAtoms', 'serial', 'stereoClass', 'stereochemistryStore',))
