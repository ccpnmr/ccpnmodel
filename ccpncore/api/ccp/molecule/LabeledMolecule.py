...
class AtomLabel(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'parent', 'resLabel', 'root', 'topObject',)
...
class LabeledMixture(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'averageComposition', 'experiments', 'labeledMolecule', 'molComponents', 'molLabelFractions', 'parent', 'root', 'topObject',)
  ...
  def findAllMolLabelFractions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'weight', 'labeledMixture', 'molLabel',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  r"""User intelligible name of LabeledMixture. The name serves as a secondary 
  key, and is used generally to identify hte relevant object. Should 
  ALWAYS be set (is left non=mandatory for difficulty of backwards 
  compatibility only). 
  """)
...
class LabeledMolecule(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllLabeledMixtures(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'averageComposition', 'labeledMolecule',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllMolLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'serial', 'labeledMolecule',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class MolLabel(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'averageLabeledMixtures', 'labeledMolecule', 'molLabelFractions', 'parent', 'resLabels', 'root', 'topObject',)
  ...
  def findAllResLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'resId', 'molLabel',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
LabeledMixture (association class).
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'weight', 'labeledMixture', 'molLabel', 'parent', 'root', 'topObject',)
...
ResLabelFractions.
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'resId', 'atomLabels', 'molLabel', 'molResidue', 'parent', 'resLabelFractions', 'root', 'topObject',)
  ...
  def findAllAtomLabels(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'massNumber', 'serial', 'weight', 'resLabel',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllResLabelFractions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'isotopomerSerial', 'schemeName', 'weight', 'resLabel',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class ResLabelFraction(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopomerSerial', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'schemeName', 'weight', 'isotopomers', 'labelingScheme', 'parent', 'resLabel', 'root', 'topObject',)
...
residue, except those attached to any SingleAtomLabel object.
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'className', 'elementName', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'parent', 'resLabel', 'root', 'topObject',)
...
and ResLabelFraction records present for the same residue ID(s)
  ...
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('_ID', 'applicationData', 'atomName', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'chemAtom', 'parent', 'resLabel', 'root', 'topObject',)
