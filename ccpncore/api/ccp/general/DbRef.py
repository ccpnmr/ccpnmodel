  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DbRef.Database.__init__")
        del dataDict['inConstructor']
        raise
...
database.
  ...
  _packageName = 'ccp.general.DbRef'
  _packageShortName = 'DBR'
  _fieldNames = ('_ID', 'altCode', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'release', 'serial', 'subCode', 'url', 'alignments', 'componentDbRefs', 'database', 'molSystems', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DbRef.Entry.__init__")
        del dataDict['inConstructor']
        raise
