...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.general.KeywordDefinition')

###############################################################################
class KeywordDefinition(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinition
  _metaclass = metaPackage.getElement('KeywordDefinition')
  _packageName = 'ccp.general.KeywordDefinition'
  _packageShortName = 'KWDF'
  _fieldNames = ('_ID', 'applicationData', 'ccpnInternalData', 'className', 'explanation', 'fieldNames', 'inConstructor', 'isDeleted', 'keyword', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'targetNames', 'keywordDefinitionStore', 'parent', 'root', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.general.KeywordDefinition.KeywordDefinition', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.KeywordDefinition.KeywordDefinition.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.KeywordDefinition.KeywordDefinition:
    undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    ...
    childrenDict = keywordDefinitionStore.__dict__.get('keywordDefinitions')
    objKey = dataDict.get('keyword')
    if (objKey is None):
  ...
  def addTargetName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTargetNames, self.addTargetName,
  ...
  def removeTargetName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTargetNames, self.removeTargetName,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setExplanation(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setExplanation, self.setExplanation,
  ...
  def setTargetNames(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTargetNames, self.setTargetNames,
...
_addModuleFunctionsToApiClass('ccp.general.KeywordDefinition.KeywordDefinition', KeywordDefinition)

###############################################################################
class KeywordDefinitionStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""Store for keyword definitions for a given context (e.g. a particular 
program or standard). 
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinitionStore
  _metaclass = metaPackage.getElement('KeywordDefinitionStore')
  _packageName = 'ccp.general.KeywordDefinition'
  _packageShortName = 'KWDF'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'context', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'keywordDefinitions', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.KeywordDefinition.KeywordDefinitionStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.KeywordDefinition.KeywordDefinitionStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.KeywordDefinition.KeywordDefinitionStore:
      undeletes objects
    *Implementation function* - will CORRUPT DATA if 
    called outside the API undo function.
    """
    ...
    childrenDict = memopsRoot.__dict__.get('keywordDefinitionStores')
    objKey = dataDict.get('context')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['context'])""" % self.qualifiedName
  ...
  def findAllKeywordDefinitions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'explanation', 'keyword', 'name', 'keywordDefinitionStore',))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.KeywordDefinition.KeywordDefinitionStore', KeywordDefinitionStore)
