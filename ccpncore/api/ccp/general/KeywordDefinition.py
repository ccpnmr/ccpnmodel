...
class KeywordDefinition(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'explanation', 'fieldNames', 'inConstructor', 'isDeleted', 'keyword', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'targetNames', 'keywordDefinitionStore', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.KeywordDefinition.KeywordDefinition.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.KeywordDefinition.KeywordDefinitionStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllKeywordDefinitions(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'explanation', 'keyword', 'name', 'keywordDefinitionStore',))
