...
class Annotation(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'date', 'description', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'serial', 'annotationStore', 'author', 'dataUrl', 'parent', 'root', 'topObject',)
...
sequence, or a simple comment for a particular residue.
  ...
  _packageName = 'ccp.general.Annotation'
  _packageShortName = 'ANNO'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'featureType', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'position', 'qualifiedName', 'serial', 'annotationStore', 'molResidue', 'parent', 'root', 'topObject',)
