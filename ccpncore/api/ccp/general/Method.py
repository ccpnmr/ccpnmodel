...
Autogenerated by PyFileApiGen on Mon May 16 03:10:53 2016
...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.general.Method')

###############################################################################
class Method(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Description of method or procedure, be it computational (calculation or 
processing) or real-world (e.g. purification).
  """
  #   from data model element ccp.general.Method.Method
  _metaclass = metaPackage.getElement('Method')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'procedure', 'qualifiedName', 'serial', 'task', 'citations', 'columns', 'compressDataSources', 'constraintLists', 'constraints', 'dataDerivations', 'dataDims', 'derivedDataLists', 'derivedNmrExperiments', 'fitPeakLists', 'instrument', 'intensPeakLists', 'measurementLists', 'measurements', 'methodStore', 'parameters', 'parent', 'peakIntensities', 'peaks', 'processDataSources', 'root', 'snDataSources', 'software', 'structureAnalyses', 'structureGenerations', 'topObject', 'violations',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.general.Method.Method', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.general.Method.Method.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Method.Method:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    childrenDict = methodStore.__dict__.get('methods')
    objKey = dataDict.get('serial')
    if (objKey is None):
    ...
    for column in dataDict.get('columns'):
      if (not (column in objsToBeUnDeleted)):
        if (column.__dict__.get('loadingMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object columns link - backLink Column.loadingMethod is not None""" % self.qualifiedName
          )

        column.__dict__['loadingMethod'] = self

    for derivedNmrExperiment in dataDict.get('derivedNmrExperiments'):
      if (not (derivedNmrExperiment in objsToBeUnDeleted)):
        if (derivedNmrExperiment.__dict__.get('derivationMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object derivedNmrExperiments link - backLink Experiment.derivationMethod is not None""" % self.qualifiedName
          )

        derivedNmrExperiment.__dict__['derivationMethod'] = self

    for fitPeakList in dataDict.get('fitPeakLists'):
      if (not (fitPeakList in objsToBeUnDeleted)):
        if (fitPeakList.__dict__.get('fitMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object fitPeakLists link - backLink PeakList.fitMethod is not None""" % self.qualifiedName
          )

        fitPeakList.__dict__['fitMethod'] = self

    instrument = dataDict.get('instrument')
    if ((instrument is not None and not (instrument in objsToBeUnDeleted))):
      methods = instrument.__dict__.get('methods')
      methods.add(self)

    for intensPeakList in dataDict.get('intensPeakLists'):
      if (not (intensPeakList in objsToBeUnDeleted)):
        if (intensPeakList.__dict__.get('intensMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object intensPeakLists link - backLink PeakList.intensMethod is not None""" % self.qualifiedName
          )

        intensPeakList.__dict__['intensMethod'] = self

    for peak in dataDict.get('peaks'):
      if (not (peak in objsToBeUnDeleted)):
        if (peak.__dict__.get('fitMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object peaks link - backLink Peak.fitMethod is not None""" % self.qualifiedName
          )

        peak.__dict__['fitMethod'] = self

    for snDataSource in dataDict.get('snDataSources'):
      if (not (snDataSource in objsToBeUnDeleted)):
        if (snDataSource.__dict__.get('snMethod') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object snDataSources link - backLink DataSource.snMethod is not None""" % self.qualifiedName
          )

        snDataSource.__dict__['snMethod'] = self
    ...
    for structureAnalysis in dataDict.get('structureAnalyses'):
      if (not (structureAnalysis in objsToBeUnDeleted)):
        if (structureAnalysis.__dict__.get('method') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object structureAnalyses link - backLink StructureAnalysis.method is not None""" % self.qualifiedName
          )

        structureAnalysis.__dict__['method'] = self

    for structureGeneration in dataDict.get('structureGenerations'):
      if (not (structureGeneration in objsToBeUnDeleted)):
        if (structureGeneration.__dict__.get('method') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Method object structureGenerations link - backLink StructureGeneration.method is not None""" % self.qualifiedName
          )

        structureGeneration.__dict__['method'] = self
  ...
  def addColumn(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.general.Instrument import Column as importedType
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.loadingMethod}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addColumn, undoArgs=(undoValueDict, 'loadingMethod'),  redoArgs=(value,))
  ...
  def addDerivedNmrExperiment(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.derivationMethod}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addDerivedNmrExperiment, undoArgs=(undoValueDict, 'derivationMethod'),  redoArgs=(value,))
  ...
  def addFitPeakList(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.fitMethod}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addFitPeakList, undoArgs=(undoValueDict, 'fitMethod'),  redoArgs=(value,))
  ...
  def addIntensPeakList(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.intensMethod}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addIntensPeakList, undoArgs=(undoValueDict, 'intensMethod'),  redoArgs=(value,))
  ...
  def addPeak(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addPeak, undoArgs=(undoValueDict, 'fitMethod'),  redoArgs=(value,))
  ...
  def addSnDataSource(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.snMethod}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addSnDataSource, undoArgs=(undoValueDict, 'snMethod'),  redoArgs=(value,))
  ...
  def addStructureAnalysis(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.method}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addStructureAnalysis, undoArgs=(undoValueDict, 'method'),  redoArgs=(value,))
  ...
  def addStructureGeneration(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addStructureGeneration, undoArgs=(undoValueDict, 'method'),  redoArgs=(value,))
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import AbstractDataDerivation as importedType
        if (not isinstance(value, importedType)):
      ...
      if (value is not None):
        from ccpnmodel.ccpncore.api.ccp.general.Instrument import Instrument as importedType
        if (not isinstance(value, importedType)):
      ...
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import PeakIntensity as importedType
        if (not isinstance(value, importedType)):
      ...
      for value in values:
        from ccpnmodel.ccpncore.api.ccp.nmr.NmrConstraint import Violation as importedType
        if (not isinstance(value, importedType)):
  ...
  def findAllColumns(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'columnType', 'details', 'instrumentType', 'model', 'name', 'serial', 'serialNumber', 'volume', 'volumeDisplayUnit', 'contactPerson', 'instrumentStore', 'loadingMethod', 'manufacturer',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDataDerivations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'serial', 'method', 'parentList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDataDims(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'dim', 'fileDim', 'gaussianBroadening', 'isComplex', 'lorentzianBroadening', 'numPoints', 'shapeSerial', 'sineWindowShift', 'unit', 'windowFunction', 'dataSource', 'expDim', 'predictMethod',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllDerivedDataLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'serial', 'method', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'paramType', 'serial', 'unit', 'value', 'method',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllPeakIntensities(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'error', 'intensityType', 'value', 'method', 'peak',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllStructureAnalyses(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'serial', 'method', 'nmrConstraintStore', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllStructureGenerations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'generationType', 'name', 'serial', 'method', 'nmrConstraintStore', 'nmrProject', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllViolations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'calcValue', 'calcValueError', 'fractionViolated', 'violation', 'constraint', 'method', 'violationList',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeColumn(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setColumns, self.removeColumn,
  ...
  def removeDerivedNmrExperiment(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDerivedNmrExperiments, self.removeDerivedNmrExperiment,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeFitPeakList(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setFitPeakLists, self.removeFitPeakList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeIntensPeakList(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIntensPeakLists, self.removeIntensPeakList,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeSnDataSource(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSnDataSources, self.removeSnDataSource,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setColumns(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.loadingMethod) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setColumns, undoArgs=(undoValueDict, 'loadingMethod'),  redoArgs=(values,))
  ...
  def setCompressDataSources(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCompressDataSources, self.setCompressDataSources,
  ...
  def setDataDerivations(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataDerivations, self.setDataDerivations,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setDataDims(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataDims, self.setDataDims,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setDerivedNmrExperiments(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.derivationMethod) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setDerivedNmrExperiments, undoArgs=(undoValueDict, 'derivationMethod'),  redoArgs=(values,))
  ...
  def setFitPeakLists(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.fitMethod) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setFitPeakLists, undoArgs=(undoValueDict, 'fitMethod'),  redoArgs=(values,))
  ...
  def setInstrument(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setInstrument, self.setInstrument,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setIntensPeakLists(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.intensMethod) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setIntensPeakLists, undoArgs=(undoValueDict, 'intensMethod'),  redoArgs=(values,))
  ...
  def setMeasurements(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMeasurements, self.setMeasurements,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setPeakIntensities(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPeakIntensities, self.setPeakIntensities,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setPeaks(self, values):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setPeaks, undoArgs=(undoValueDict, 'fitMethod'),  redoArgs=(values,))
  ...
  def setProcedure(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setProcedure, self.setProcedure,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setProcessDataSources(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setProcessDataSources, self.setProcessDataSources,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setSnDataSources(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.snMethod) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setSnDataSources, undoArgs=(undoValueDict, 'snMethod'),  redoArgs=(values,))
  ...
  def setStructureAnalyses(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.method) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setStructureAnalyses, undoArgs=(undoValueDict, 'method'),  redoArgs=(values,))
  ...
  def setStructureGenerations(self, values):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setStructureGenerations, undoArgs=(undoValueDict, 'method'),  redoArgs=(values,))
  ...
  def setTask(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTask, self.setTask,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
_addModuleFunctionsToApiClass('ccp.general.Method.Method', Method)

###############################################################################
class MethodStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""grouping of Methods
  """
  #   from data model element ccp.general.Method.MethodStore
  _metaclass = metaPackage.getElement('MethodStore')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'memopsRoot', 'methods', 'packageLocator', 'parent', 'root', 'software', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Method.MethodStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.general.Method.MethodStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Method.MethodStore:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = memopsRoot.__dict__.get('methodStores')
    objKey = dataDict.get('name')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['name'])""" % self.qualifiedName
  ...
  def findAllMethods(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'procedure', 'serial', 'task', 'instrument', 'methodStore', 'software',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllSoftware(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'details', 'name', 'vendorAddress', 'vendorName', 'vendorWebAddress', 'version', 'methodStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Method.MethodStore', MethodStore)

###############################################################################
class Parameter(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Parameters used for the Method.
  """
  #   from data model element ccp.general.Method.Parameter
  _metaclass = metaPackage.getElement('Parameter')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'paramType', 'qualifiedName', 'serial', 'unit', 'value', 'method', 'parent', 'root', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Method.Parameter', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.general.Method.Parameter.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Method.Parameter:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    if (not (method in objsToBeUnDeleted)):
      ...
      childrenDict = method.__dict__.get('parameters')
      objKey = dataDict.get('serial')
      if (objKey is None):
        raise ApiError("""%s._singleUnDelete:
         Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def setParamType(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setParamType, self.setParamType,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Method.Parameter', Parameter)

###############################################################################
class Software(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Program used for some task or tasks.
  """
  #   from data model element ccp.general.Method.Software
  _metaclass = metaPackage.getElement('Software')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'tasks', 'vendorAddress', 'vendorName', 'vendorWebAddress', 'version', 'citations', 'entries', 'methodStore', 'methods', 'parent', 'root', 'topObject', 'validationStores',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Method.Software', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.error("in ccp.general.Method.Software.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Method.Software:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = methodStore.__dict__.get('software')
    ll = list()
    objKey = dataDict.get('name')
    ll.append(objKey)
    if (objKey is not None):
    ...
    for method in dataDict.get('methods'):
      if (not (method in objsToBeUnDeleted)):
        if (method.__dict__.get('software') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of Software object methods link - backLink Method.software is not None""" % self.qualifiedName
          )

        method.__dict__['software'] = self
  ...
  def addMethod(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.software}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addMethod, undoArgs=(undoValueDict, 'software'),  redoArgs=(value,))
  ...
  def addTask(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTasks, self.addTask,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeTask(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTasks, self.removeTask,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setMethods(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.software) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setMethods, undoArgs=(undoValueDict, 'software'),  redoArgs=(values,))
  ...
  def setTasks(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setTasks, self.setTasks,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setValidationStores(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setValidationStores, self.setValidationStores,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setVendorAddress(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setVendorAddress, self.setVendorAddress,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setVendorName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setVendorName, self.setVendorName,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setVendorWebAddress(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setVendorWebAddress, self.setVendorWebAddress,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.Path import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Method.Software', Software)
