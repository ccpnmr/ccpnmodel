...
class NaturalSource(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'atccNumber', 'ccpnInternalData', 'cellLine', 'cellLocation', 'cellType', 'className', 'details', 'fieldNames', 'fraction', 'geneMnemonic', 'genus', 'ictvCode', 'inConstructor', 'isDeleted', 'kingdom', 'metaclass', 'ncbiTaxonomyId', 'organ', 'organelle', 'organismAcronym', 'organismName', 'packageName', 'packageShortName', 'plasmid', 'plasmidDetails', 'qualifiedName', 'scientificName', 'secretion', 'serial', 'species', 'strain', 'subVariant', 'superKingdom', 'tissue', 'variant', 'entryMolecules', 'molSeqFragments', 'molecules', 'parent', 'root', 'taxonomy', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.general.Taxonomy.NaturalSource.__init__")
        del dataDict['inConstructor']
        raise
...
class Taxonomy(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  _packageName = 'ccp.general.Taxonomy'
  _packageShortName = 'TAXO'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'memopsRoot', 'naturalSources', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.debug("in ccp.general.Taxonomy.Taxonomy.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllNaturalSources(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'atccNumber', 'ccpnInternalData', 'cellLine', 'cellLocation', 'cellType', 'details', 'fraction', 'geneMnemonic', 'genus', 'ictvCode', 'kingdom', 'ncbiTaxonomyId', 'organ', 'organelle', 'organismAcronym', 'organismName', 'plasmid', 'plasmidDetails', 'scientificName', 'secretion', 'serial', 'species', 'strain', 'subVariant', 'superKingdom', 'tissue', 'variant', 'taxonomy',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
