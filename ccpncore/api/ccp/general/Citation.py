...
metaPackage = ccpnmodel.ccpncore.api.memops.Implementation.topPackage.metaObjFromQualName('ccp.general.Citation')

###############################################################################
class Citation(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  r"""Citation (litterature reference).
  """
  #   from data model element ccp.general.Citation.Citation
  _metaclass = metaPackage.getElement('Citation')
  _packageName = 'ccp.general.Citation'
  _packageShortName = 'CITA'
  _fieldNames = ('_ID', 'applicationData', 'casAbstractCode', 'ccpnInternalData', 'className', 'details', 'doi', 'fieldNames', 'firstPage', 'inConstructor', 'isDeleted', 'keywords', 'lastPage', 'medlineUiCode', 'metaclass', 'packageName', 'packageShortName', 'pubMedId', 'qualifiedName', 'serial', 'status', 'title', 'year', 'authors', 'citationStore', 'dataLists', 'editors', 'experiments', 'methods', 'molSystems', 'molecules', 'nmrEntries', 'nmrEntriesPrimary', 'nmrProbes', 'nmrSpectrometers', 'parent', 'ratioShiftReferences', 'root', 'sampleConditionSets', 'shiftReferences', 'software', 'topObject',)
  ...
  def addEditor(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setEditors, self.addEditor,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def addNmrEntryPrimary(self, value):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.primaryCitation}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addNmrEntryPrimary, undoArgs=(undoValueDict, 'primaryCitation'),  redoArgs=(value,))
  ...
  def addShiftReference(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import ShiftReference as importedType
    if (not isinstance(value, importedType)):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = {value:value.citation}
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.addShiftReference, undoArgs=(undoValueDict, 'citation'),  redoArgs=(value,))
  ...
  def findAllDataLists(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'definition', 'details', 'name', 'serial', 'sf', 'unit', 'method', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllRatioShiftReferences(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'atomGroup', 'ccpnInternalData', 'indirectShiftRatio', 'isotopeCode', 'molName', 'referenceType', 'serial', 'unit', 'value', 'citation', 'nmrProject', 'shiftRatioCitation',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllSampleConditionSets(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'ccpnInternalData', 'details', 'name', 'serial', 'nmrProject',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def removeEditor(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setEditors, self.removeEditor,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeNmrEntryPrimary(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrEntriesPrimary, self.removeNmrEntryPrimary,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def removeShiftReference(self, value):
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setShiftReferences, self.removeShiftReference,
                      undoArgs=(undoValues,), redoArgs=(value,))
  ...
  def setCasAbstractCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCasAbstractCode, self.setCasAbstractCode,
  ...
  def setDataLists(self, values):
    ...
    for value in values:
      from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import DataList as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setDataLists:
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDataLists, self.setDataLists,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setDoi(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setDoi, self.setDoi,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setEditors(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setEditors, self.setEditors,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setFirstPage(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setFirstPage, self.setFirstPage,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setLastPage(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setLastPage, self.setLastPage,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMedlineUiCode(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMedlineUiCode, self.setMedlineUiCode,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setMethods(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMethods, self.setMethods,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setMolecules(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setMolecules, self.setMolecules,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setNmrEntriesPrimary(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.primaryCitation) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setNmrEntriesPrimary, undoArgs=(undoValueDict, 'primaryCitation'),  redoArgs=(values,))
  ...
  def setNmrProbes(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrProbes, self.setNmrProbes,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setNmrSpectrometers(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setNmrSpectrometers, self.setNmrSpectrometers,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setPubMedId(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPubMedId, self.setPubMedId,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setRatioShiftReferences(self, values):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setRatioShiftReferences, self.setRatioShiftReferences,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setSampleConditionSets(self, values):
    ...
    for value in values:
      from ccpnmodel.ccpncore.api.ccp.nmr.Nmr import SampleConditionSet as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setSampleConditionSets:
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setSampleConditionSets, self.setSampleConditionSets,
                      undoArgs=(currentValues,), redoArgs=(values,))
  ...
  def setShiftReferences(self, values):
    ...
    notOverride = (notOverride and notIsReading)
    if (notIsReading):
      undoValueDict = collections.OrderedDict((x, x.citation) for y in (currentValues, values) for x in y)
    ...
    if (notIsReading):
      ...
      if _undo is not None:
        ...
        _undo.newItem(restoreOriginalLinks, self.setShiftReferences, undoArgs=(undoValueDict, 'citation'),  redoArgs=(values,))
  ...
  def setStatus(self, value):
    ...
    if (value is not None):
      ...
      if (_lenValue > 1024):
        raise ApiError("""%s.setStatus:
         ccp.general.Citation.CitationStatus maximum length is 1024 violated by value""" % self.qualifiedName
         + ": %s" % (value,)
        )
  ...
  def setYear(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setYear, self.setYear,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
_addModuleFunctionsToApiClass('ccp.general.Citation.Citation', Citation)

###############################################################################
class CitationStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  r"""Grouping of Citations
  """
  #   from data model element ccp.general.Citation.CitationStore
  _metaclass = metaPackage.getElement('CitationStore')
  _packageName = 'ccp.general.Citation'
  _packageShortName = 'CITA'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'ccpnInternalData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'citations', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % ('ccp.general.Citation.CitationStore', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.Citation.CitationStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Citation.CitationStore:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    childrenDict = memopsRoot.__dict__.get('citationStores')
    objKey = dataDict.get('name')
    if (objKey is None):
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Citation.CitationStore', CitationStore)

###############################################################################
class BookCitation(Citation):
  r"""Citation (litterature reference) for book or book chapter.
  """
  #   from data model element ccp.general.Citation.BookCitation
  _metaclass = metaPackage.getElement('BookCitation')
  _packageName = 'ccp.general.Citation'
  _packageShortName = 'CITA'
  _fieldNames = ('_ID', 'applicationData', 'bookSeries', 'bookTitle', 'casAbstractCode', 'ccpnInternalData', 'className', 'details', 'doi', 'fieldNames', 'firstPage', 'inConstructor', 'isDeleted', 'isbn', 'keywords', 'lastPage', 'medlineUiCode', 'metaclass', 'packageName', 'packageShortName', 'pubMedId', 'publisher', 'publisherCity', 'qualifiedName', 'serial', 'status', 'title', 'volume', 'year', 'authors', 'citationStore', 'dataLists', 'editors', 'experiments', 'methods', 'molSystems', 'molecules', 'nmrEntries', 'nmrEntriesPrimary', 'nmrProbes', 'nmrSpectrometers', 'parent', 'ratioShiftReferences', 'root', 'sampleConditionSets', 'shiftReferences', 'software', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Citation.BookCitation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.Citation.BookCitation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Citation.BookCitation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    childrenDict = citationStore.__dict__.get('citations')
    objKey = dataDict.get('serial')
    if (objKey is None):
      raise ApiError("""%s._singleUnDelete:
       Key attribute or link not set (from ['serial'])""" % self.qualifiedName
    ...
    for author in dataDict.get('authors'):
      if (not (author in objsToBeUnDeleted)):
        authorCitations = author.__dict__.get('authorCitations')
        authorCitations.add(self)

    for editor in dataDict.get('editors'):
      if (not (editor in objsToBeUnDeleted)):
        editorCitations = editor.__dict__.get('editorCitations')
        editorCitations.add(self)
    ...
    for nmrEntry in dataDict.get('nmrEntries'):
      if (not (nmrEntry in objsToBeUnDeleted)):
        otherCitations = nmrEntry.__dict__.get('otherCitations')
        otherCitations.add(self)

    for nmrEntryPrimary in dataDict.get('nmrEntriesPrimary'):
      if (not (nmrEntryPrimary in objsToBeUnDeleted)):
        if (nmrEntryPrimary.__dict__.get('primaryCitation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of BookCitation object nmrEntriesPrimary link - backLink Entry.primaryCitation is not None""" % self.qualifiedName
          )

        nmrEntryPrimary.__dict__['primaryCitation'] = self

    for shiftReference in dataDict.get('shiftReferences'):
      if (not (shiftReference in objsToBeUnDeleted)):
        if (shiftReference.__dict__.get('citation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of BookCitation object shiftReferences link - backLink ShiftReference.citation is not None""" % self.qualifiedName
          )

        shiftReference.__dict__['citation'] = self
  ...
  def setBookSeries(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setBookSeries, self.setBookSeries,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setBookTitle(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setBookTitle, self.setBookTitle,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setIsbn(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIsbn, self.setIsbn,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setPublisher(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPublisher, self.setPublisher,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setPublisherCity(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setPublisherCity, self.setPublisherCity,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Citation.BookCitation', BookCitation)

###############################################################################
class ConferenceCitation(Citation):
  r"""Citation (litterature reference) to Conference presentation
  """
  #   from data model element ccp.general.Citation.ConferenceCitation
  _metaclass = metaPackage.getElement('ConferenceCitation')
  _packageName = 'ccp.general.Citation'
  _packageShortName = 'CITA'
  _fieldNames = ('_ID', 'abstractNumber', 'applicationData', 'casAbstractCode', 'ccpnInternalData', 'city', 'className', 'conferenceSite', 'conferenceTitle', 'country', 'details', 'doi', 'endDate', 'fieldNames', 'firstPage', 'inConstructor', 'isDeleted', 'keywords', 'lastPage', 'medlineUiCode', 'metaclass', 'packageName', 'packageShortName', 'pubMedId', 'qualifiedName', 'serial', 'startDate', 'stateProvince', 'status', 'title', 'year', 'authors', 'citationStore', 'dataLists', 'editors', 'experiments', 'methods', 'molSystems', 'molecules', 'nmrEntries', 'nmrEntriesPrimary', 'nmrProbes', 'nmrSpectrometers', 'parent', 'ratioShiftReferences', 'root', 'sampleConditionSets', 'shiftReferences', 'software', 'topObject',)
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Citation.ConferenceCitation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.Citation.ConferenceCitation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Citation.ConferenceCitation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for nmrEntryPrimary in dataDict.get('nmrEntriesPrimary'):
      if (not (nmrEntryPrimary in objsToBeUnDeleted)):
        if (nmrEntryPrimary.__dict__.get('primaryCitation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ConferenceCitation object nmrEntriesPrimary link - backLink Entry.primaryCitation is not None""" % self.qualifiedName
          )
    ...
    for shiftReference in dataDict.get('shiftReferences'):
      if (not (shiftReference in objsToBeUnDeleted)):
        if (shiftReference.__dict__.get('citation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ConferenceCitation object shiftReferences link - backLink ShiftReference.citation is not None""" % self.qualifiedName
          )
  ...
  def setAbstractNumber(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAbstractNumber, self.setAbstractNumber,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setConferenceSite(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConferenceSite, self.setConferenceSite,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setConferenceTitle(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setConferenceTitle, self.setConferenceTitle,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setStartDate(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStartDate, self.setStartDate,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setStateProvince(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setStateProvince, self.setStateProvince,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
class JournalCitation(Citation):
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Citation.JournalCitation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.Citation.JournalCitation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Citation.JournalCitation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for nmrEntryPrimary in dataDict.get('nmrEntriesPrimary'):
      if (not (nmrEntryPrimary in objsToBeUnDeleted)):
        if (nmrEntryPrimary.__dict__.get('primaryCitation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of JournalCitation object nmrEntriesPrimary link - backLink Entry.primaryCitation is not None""" % self.qualifiedName
          )
    ...
    for shiftReference in dataDict.get('shiftReferences'):
      if (not (shiftReference in objsToBeUnDeleted)):
        if (shiftReference.__dict__.get('citation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of JournalCitation object shiftReferences link - backLink ShiftReference.citation is not None""" % self.qualifiedName
          )
  ...
  def setAstm(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setAstm, self.setAstm,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setCsd(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setCsd, self.setCsd,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setIssn(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIssn, self.setIssn,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setIssue(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setIssue, self.setIssue,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setJournalAbbreviation(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setJournalAbbreviation, self.setJournalAbbreviation,
                      undoArgs=(currentValue,), redoArgs=(value,))
  ...
  def setJournalFullName(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setJournalFullName, self.setJournalFullName,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
class ThesisCitation(Citation):
    ...
    try:
      ...
      try:
        ...
        if (dataDict.get('_ID') is None):
          ...
          raise ApiError("""%s.__init__:
           Class %s - set explicit _ID %s when not reading""" % self.qualifiedName
           + ": %s:%s" % ('ccp.general.Citation.ThesisCitation', value)
          )

        del dataDict['inConstructor']
      except:
        self.root._logger.debug("in ccp.general.Citation.ThesisCitation.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def _singleUnDelete(self, objsToBeUnDeleted):
    """
    singleUnDelete for ccp.general.Citation.ThesisCitation:   undeletes
    objects
    *Implementation function* - will CORRUPT DATA if called outside 
    the API undo function.
    """
    ...
    for nmrEntryPrimary in dataDict.get('nmrEntriesPrimary'):
      if (not (nmrEntryPrimary in objsToBeUnDeleted)):
        if (nmrEntryPrimary.__dict__.get('primaryCitation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ThesisCitation object nmrEntriesPrimary link - backLink Entry.primaryCitation is not None""" % self.qualifiedName
          )
    ...
    for shiftReference in dataDict.get('shiftReferences'):
      if (not (shiftReference in objsToBeUnDeleted)):
        if (shiftReference.__dict__.get('citation') is not None):
          raise ApiError("""%s._singleUnDelete:
           Error undoing delete of ThesisCitation object shiftReferences link - backLink ShiftReference.citation is not None""" % self.qualifiedName
          )
  ...
  def setInstitution(self, value):
    ...
    if ((notInConstructor and notIsReading)):
      ...
      if _undo is not None:
        ...
        _undo.newItem(self.setInstitution, self.setInstitution,
                      undoArgs=(currentValue,), redoArgs=(value,))
...
from ccpnmodel.ccpncore.lib.ApiPath import _addModuleFunctionsToApiClass
_addModuleFunctionsToApiClass('ccp.general.Citation.ThesisCitation', ThesisCitation)
