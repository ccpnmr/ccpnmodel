...
experiment.
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'serialNumber', 'contactPerson', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
...
class InstrumentStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('_ID', '_lastId', 'applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'activeRepositories', 'instruments', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.Instrument.InstrumentStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllInstruments(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'details', 'instrumentType', 'model', 'name', 'serial', 'serialNumber', 'contactPerson', 'instrumentStore', 'manufacturer',))
...
class Instrument(AbstractInstrument):
  ...
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'serialNumber', 'contactPerson', 'instrumentStore', 'manufacturer', 'methods', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.Instrument.Instrument.__init__")
        del dataDict['inConstructor']
        raise
...
class NmrProbe(AbstractInstrument):
  ...
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'diameter', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'packageName', 'packageShortName', 'probeType', 'qualifiedName', 'serial', 'serialNumber', 'citations', 'contactPerson', 'experiments', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.Instrument.NmrProbe.__init__")
        del dataDict['inConstructor']
        raise
...
class NmrSpectrometer(AbstractInstrument):
  ...
  _packageName = 'ccp.general.Instrument'
  _packageShortName = 'INST'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'instrumentType', 'isDeleted', 'metaclass', 'model', 'name', 'nominalFreq', 'packageName', 'packageShortName', 'protonFreq', 'qualifiedName', 'serial', 'serialNumber', 'citations', 'contactPerson', 'experiments', 'instrumentStore', 'manufacturer', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.Instrument.NmrSpectrometer.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.Instrument.Column.__init__")
        del dataDict['inConstructor']
        raise
