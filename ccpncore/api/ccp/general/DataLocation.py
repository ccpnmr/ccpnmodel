...
Autogenerated by PyFileApiGen on Sun May 15 02:19:05 2016
...
class AbstractDataStore(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'fullPath', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'serial', 'dataLocationStore', 'dataUrl', 'parent', 'root', 'topObject',)
...
class Component(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('_ID', 'amplitude', 'annotation', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'regionId', 'serial', 'status', 'parent', 'root', 'shapeMatrix', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.Component.__init__")
        del dataDict['inConstructor']
        raise
...
reconstruct a component.
  ...
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'dims', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'parent', 'root', 'shapeMatrix', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.ComponentShape.__init__")
        del dataDict['inConstructor']
        raise
...
class DataLocationStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.DataLocationStore.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllDataStores(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'details', 'path', 'serial', 'dataLocationStore', 'dataUrl',))
  ...
  def findAllDataUrls(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'name', 'serial', 'url', 'dataLocationStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class DataUrl(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'url', 'annotations', 'dataLocationStore', 'dataStores', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.DataUrl.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllAnnotations(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'date', 'description', 'details', 'name', 'path', 'serial', 'annotationStore', 'author', 'dataUrl',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class MimeTypeDataStore(AbstractDataStore):
  ...
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('_ID', 'applicationData', 'className', 'details', 'fieldNames', 'fullPath', 'inConstructor', 'isDeleted', 'metaclass', 'mimeType', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'serial', 'dataLocationStore', 'dataUrl', 'nmrDataSourceImage', 'parent', 'photoPersons', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.MimeTypeDataStore.__init__")
        del dataDict['inConstructor']
        raise
...
class BlockedBinaryMatrix(NumericMatrix):
  ...
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('_ID', 'applicationData', 'blockHeaderSize', 'blockSizes', 'className', 'complexStoredBy', 'details', 'fieldNames', 'fileType', 'fullPath', 'hasBlockPadding', 'headerSize', 'inConstructor', 'isBigEndian', 'isComplex', 'isDeleted', 'metaclass', 'nByte', 'numDims', 'numPoints', 'numRecords', 'numberType', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'scaleFactor', 'serial', 'dataLocationStore', 'dataUrl', 'nmrDataSources', 'parent', 'root', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.BlockedBinaryMatrix.__init__")
        del dataDict['inConstructor']
        raise
...
header size refers to the header of the entire dataasource.
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        self.root._logger.error("in ccp.general.DataLocation.ShapeMatrix.__init__")
        del dataDict['inConstructor']
        raise
  ...
  def findAllComponentShapes(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'serial', 'shapeMatrix',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllComponents(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'amplitude', 'annotation', 'regionId', 'serial', 'status', 'shapeMatrix',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
