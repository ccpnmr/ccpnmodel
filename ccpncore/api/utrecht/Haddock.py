...
class Chain(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'chain', 'haddockPartner', 'parent', 'residues', 'root', 'topObject',)
  ...
  def findAllResidues(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'flexibility', 'haddockSeqId', 'interaction', 'chain', 'residue',))
...
class EnergyTermParameter(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'utrecht.Haddock'
  _packageShortName = 'HADD'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'value', 'haddockEnergyTerm', 'parent', 'root', 'topObject',)
...
class HaddockEnergyTerm(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'utrecht.Haddock'
  _packageShortName = 'HADD'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'fileName', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'termId', 'constraintList', 'energyTerm', 'energyTermParameters', 'parent', 'root', 'run', 'topObject',)
  ...
  def findAllEnergyTermParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'value', 'haddockEnergyTerm',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class HaddockPartner(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'utrecht.Haddock'
  _packageShortName = 'HADD'
  _fieldNames = ('_ID', 'airUpperDistanceLimit', 'applicationData', 'autoHistidinePstate', 'className', 'code', 'fieldNames', 'fileNames', 'forceFieldCode', 'inConstructor', 'isDeleted', 'isDna', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'semiFlexMode', 'chains', 'haddockProject', 'molSystem', 'parent', 'root', 'structureEnsemble', 'topObject',)
  ...
  def findAllChains(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'chain', 'haddockPartner',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class HaddockProject(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllHaddockPartners(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'airUpperDistanceLimit', 'autoHistidinePstate', 'code', 'forceFieldCode', 'isDna', 'semiFlexMode', 'haddockProject', 'molSystem', 'structureEnsemble',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class Residue(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'utrecht.Haddock'
  _packageShortName = 'HADD'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'flexibility', 'haddockSeqId', 'inConstructor', 'interaction', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'chain', 'parent', 'residue', 'root', 'topObject',)
...
class Run(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  def findAllScoringWeights(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'stage', 'term', 'value', 'run',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllSymmetryRestraints(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'segmentLength', 'serial', 'symmetryCode', 'molSystemSymmetrySet',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class ScoringWeight(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'utrecht.Haddock'
  _packageShortName = 'HADD'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'stage', 'term', 'value', 'parent', 'root', 'run', 'topObject',)
