...
general terms.
  ...
  _fieldNames = ('_ID', 'application', 'applicationData', 'applicationVersion', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'methodStoreName', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'annealProtocolStore', 'annealStages', 'energyTerms', 'haddockRuns', 'nmrCalcRuns', 'parent', 'root', 'software', 'topObject',)
  ...
  def findAllAnnealStages(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        ...
        directAttrs = frozenset(('_ID', 'finalTemp', 'function', 'initialTemp', 'name', 'numSteps', 'numSubSteps', 'serial', 'timeStep', 'timeStepScaling', 'annealProtocol',))
  ...
  def findAllEnergyTerms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'details', 'name', 'serial', 'annealProtocol',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class AnnealProtocolStore(ccpnmodel.ccpncore.api.memops.Implementation.TopObject):
  ...
  def findAllAnnealProtocols(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'application', 'applicationVersion', 'code', 'details', 'methodStoreName', 'name', 'annealProtocolStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllRefPotentialTerms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'application', 'code', 'details', 'index', 'name', 'annealProtocolStore',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class AnnealStage(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'fieldNames', 'finalTemp', 'function', 'functionParams', 'inConstructor', 'initialTemp', 'isDeleted', 'metaclass', 'name', 'numSteps', 'numSubSteps', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'timeStep', 'timeStepScaling', 'annealProtocol', 'parent', 'potentialScales', 'root', 'topObject',)
  ...
  def findAllPotentialScales(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'finalScale', 'function', 'initialScale', 'annealStage', 'energyTerm', 'refPotentialTerm',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
refPotentialTerms
  ...
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'annealProtocol', 'haddockEnergyTerms', 'nmrCalcEnergyTerms', 'parent', 'potentialScales', 'root', 'topObject',)
  ...
  def findAllHaddockEnergyTerms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'details', 'fileName', 'name', 'termId', 'constraintList', 'energyTerm', 'run',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
  ...
  def findAllNmrCalcEnergyTerms(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'annealEnergyTermSerial', 'code', 'constraintStoreSerial', 'details', 'ioRole', 'name', 'serial', 'parameterGroup', 'run',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class PotentialScale(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'fieldNames', 'finalScale', 'function', 'functionParams', 'inConstructor', 'initialScale', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'annealStage', 'energyTerm', 'parent', 'refPotentialTerm', 'root', 'topObject',)
...
interpretation generally requires reference to the application.
  ...
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('_ID', 'application', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'annealProtocolStore', 'parent', 'potentialScales', 'refTermParameters', 'root', 'topObject',)
  ...
  def findAllRefTermParameters(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if ((nConditions == 1)):
        (key, condition) = items[0]
        directAttrs = frozenset(('_ID', 'code', 'details', 'name', 'value', 'refPotentialTerm',))
        if (key in directAttrs):
          for v in currentValues:
            if (condition == v.__dict__.get(key)):
              result.add(v)
...
class RefTermParameter(ccpnmodel.ccpncore.api.memops.Implementation.DataObject):
  ...
  _packageName = 'molsim.AnnealProtocol'
  _packageShortName = 'ANPR'
  _fieldNames = ('_ID', 'applicationData', 'className', 'code', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'value', 'parent', 'refPotentialTerm', 'root', 'topObject',)
